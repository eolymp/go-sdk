...
type _OAuth2HttpClient interface {
	Do(*http.Request) (*http.Response, error)
}

type OAuth2Service struct {
	base string
	cli  _OAuth2HttpClient
}

// NewOAuth2HttpClient constructs client for OAuth2
func NewOAuth2HttpClient(url string, cli _OAuth2HttpClient) *OAuth2Service {
	if url == "" {
	...
	return &OAuth2Service{base: url, cli: cli}
}

func (s *OAuth2Service) do(ctx context.Context, verb, path string, in, out proto.Message) (err error) {
	var body io.Reader
