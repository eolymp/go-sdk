...
var file_eolymp_executor_report_proto_goTypes = []any{
...
func file_eolymp_executor_report_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_eolymp_executor_report_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Report); i {
			case 0:
				return &v.state
			case 1:
		...
		file_eolymp_executor_report_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_eolymp_executor_report_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_eolymp_executor_report_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_eolymp_executor_report_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_eolymp_executor_report_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_eolymp_executor_report_proto_msgTypes[6].Exporter = func(v any, i int) any {
	...
	file_eolymp_executor_report_proto_msgTypes[3].OneofWrappers = []any{
