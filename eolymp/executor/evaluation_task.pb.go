...
func (x *EvaluationTask_Run) GetInputGenerator() string {
	if x != nil {
...
type EvaluationTask_Run_InputGenerator struct {
	InputGenerator string `protobuf:"bytes,13,opt,name=input_generator,json=inputGenerator,proto3,oneof"` // use a script to generate input
}
...
var file_eolymp_executor_evaluation_task_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0x9a, 0x0d, 0x0a, 0x0e, 0x45, 0x76, 0x61, 0x6c, 0x75, 0x61, 0x74, 0x69,
	...
	0x1a, 0xc1, 0x03, 0x0a, 0x03, 0x52, 0x75, 0x6e, 0x12, 0x1c, 0x0a, 0x09, 0x72, 0x65, 0x66, 0x65,
	...
	,
	...
	0x73, 0x77, 0x65, 0x72, 0x1a, 0x9f, 0x01, 0x0a, 0x0c, 0x50, 0x72, 0x65, 0x63, 0x6f, 0x6e, 0x64,
...
var file_eolymp_executor_evaluation_task_proto_goTypes = []any{
	...
	nil,                                 // 5: eolymp.executor.EvaluationTask.Run.EnvEntry
	(*File)(nil),                        // 6: eolymp.executor.File
	(*Checker)(nil),                     // 7: eolymp.executor.Checker
	(*Interactor)(nil),                  // 8: eolymp.executor.Interactor
	(*Script)(nil),                      // 9: eolymp.executor.Script
}
var file_eolymp_executor_evaluation_task_proto_depIdxs = []int32{
	6, // 0: eolymp.executor.EvaluationTask.files:type_name -> eolymp.executor.File
	3, // 1: eolymp.executor.EvaluationTask.preconditions:type_name -> eolymp.executor.EvaluationTask.Precondition
	4, // 2: eolymp.executor.EvaluationTask.constraints:type_name -> eolymp.executor.EvaluationTask.Constraint
	7, // 3: eolymp.executor.EvaluationTask.checker:type_name -> eolymp.executor.Checker
	8, // 4: eolymp.executor.EvaluationTask.interactor:type_name -> eolymp.executor.Interactor
	9, // 5: eolymp.executor.EvaluationTask.scripts:type_name -> eolymp.executor.Script
	2, // 6: eolymp.executor.EvaluationTask.runs:type_name -> eolymp.executor.EvaluationTask.Run
	5, // 7: eolymp.executor.EvaluationTask.Run.env:type_name -> eolymp.executor.EvaluationTask.Run.EnvEntry
