...
var file_eolymp_executor_evaluation_task_proto_goTypes = []any{
	...
	(*File)(nil),                        // 8: eolymp.executor.File
...
var file_eolymp_executor_evaluation_task_proto_depIdxs = []int32{
	...
	6,  // 2: eolymp.executor.EvaluationTask.checker:type_name -> eolymp.executor.Checker
	7,  // 3: eolymp.executor.EvaluationTask.interactor:type_name -> eolymp.executor.Interactor
	2,  // 4: eolymp.executor.EvaluationTask.runs:type_name -> eolymp.executor.EvaluationTask.Run
	8,  // 5: eolymp.executor.EvaluationTask.files:type_name -> eolymp.executor.File
	9,  // 6: eolymp.executor.EvaluationTask.scripts:type_name -> eolymp.executor.Script
