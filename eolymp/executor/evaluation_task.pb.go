...
type EvaluationTask_Run struct {
	...
	//
	//	*EvaluationTask_Run_InputObjectId
	...
	//
	//	*EvaluationTask_Run_AnswerObjectId
...
func (x *EvaluationTask_Run) GetInputObjectId() string {
	if x, ok := x.GetInput().(*EvaluationTask_Run_InputObjectId); ok {
...
func (x *EvaluationTask_Run) GetAnswerObjectId() string {
	if x, ok := x.GetAnswer().(*EvaluationTask_Run_AnswerObjectId); ok {
...
type EvaluationTask_Run_InputObjectId struct {
...
func (*EvaluationTask_Run_InputObjectId) isEvaluationTask_Run_Input() {}
...
type EvaluationTask_Run_AnswerObjectId struct {
...
func (*EvaluationTask_Run_AnswerObjectId) isEvaluationTask_Run_Answer() {}
...
var file_eolymp_executor_evaluation_task_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0xfb, 0x0d, 0x0a, 0x0e, 0x45, 0x76, 0x61, 0x6c, 0x75, 0x61, 0x74, 0x69,
	...
	0x1a, 0xa2, 0x04, 0x0a, 0x03, 0x52, 0x75, 0x6e, 0x12, 0x1c, 0x0a, 0x09, 0x72, 0x65, 0x66, 0x65,
	...
	,
	...
	0x61, 0x74, 0x6f, 0x72, 0x12, 0x2a, 0x0a, 0x10, 0x61, 0x6e, 0x73, 0x77, 0x65, 0x72, 0x5f, 0x6f,
	0x62, 0x6a, 0x65, 0x63, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x14, 0x20, 0x01, 0x28, 0x09, 0x48, 0x01,
	...
	0x65, 0x72, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x12, 0x1f, 0x0a, 0x0a, 0x61, 0x6e, 0x73,
	0x77, 0x65, 0x72, 0x5f, 0x75, 0x72, 0x6c, 0x18, 0x16, 0x20, 0x01, 0x28, 0x09, 0x48, 0x01, 0x52,
	0x09, 0x61, 0x6e, 0x73, 0x77, 0x65, 0x72, 0x55, 0x72, 0x6c, 0x12, 0x56, 0x0a, 0x10, 0x61, 0x6e,
...
func file_eolymp_executor_evaluation_task_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_eolymp_executor_evaluation_task_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*EvaluationTask); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_eolymp_executor_evaluation_task_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*EvaluationTask_Generator); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_eolymp_executor_evaluation_task_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*EvaluationTask_Run); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_eolymp_executor_evaluation_task_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*EvaluationTask_Precondition); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_eolymp_executor_evaluation_task_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*EvaluationTask_Constraint); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
