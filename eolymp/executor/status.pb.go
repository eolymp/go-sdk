...
type Status_Run struct {
	...
	StderrUrl string `protobuf:"bytes,21,opt,name=stderr_url,json=stderrUrl,proto3" json:"stderr_url,omitempty"`
	...
	VerifierLogUrl        string `protobuf:"bytes,31,opt,name=verifier_log_url,json=verifierLogUrl,proto3" json:"verifier_log_url,omitempty"`                         // URL for verifier's full log
	VerifierWallTimeUsage uint32 `protobuf:"varint,32,opt,name=verifier_wall_time_usage,json=verifierWallTimeUsage,proto3" json:"verifier_wall_time_usage,omitempty"` // verifier's wall time usage in milliseconds
	VerifierMemoryUsage   uint64 `protobuf:"varint,33,opt,name=verifier_memory_usage,json=verifierMemoryUsage,proto3" json:"verifier_memory_usage,omitempty"`         // verifier's wall time usage in bytes
	VerifierExitCode      uint32 `protobuf:"varint,34,opt,name=verifier_exit_code,json=verifierExitCode,proto3" json:"verifier_exit_code,omitempty"`                  // verifier's exit code
	...
	InteractorLogUrl        string `protobuf:"bytes,41,opt,name=interactor_log_url,json=interactorLogUrl,proto3" json:"interactor_log_url,omitempty"`                         // URL for interactor's full log
	InteractorWallTimeUsage uint32 `protobuf:"varint,42,opt,name=interactor_wall_time_usage,json=interactorWallTimeUsage,proto3" json:"interactor_wall_time_usage,omitempty"` // interactor's wall time usage in milliseconds
	InteractorMemoryUsage   uint64 `protobuf:"varint,43,opt,name=interactor_memory_usage,json=interactorMemoryUsage,proto3" json:"interactor_memory_usage,omitempty"`         // interactor's wall time usage in bytes
	InteractorExitCode      uint32 `protobuf:"varint,44,opt,name=interactor_exit_code,json=interactorExitCode,proto3" json:"interactor_exit_code,omitempty"`                  // interactor's exit code
}
...
func (x *Status_Run) GetVerifierLogUrl() string {
	if x != nil {
		return x.VerifierLogUrl
	}
	return ""
}

func (x *Status_Run) GetVerifierWallTimeUsage() uint32 {
	if x != nil {
		return x.VerifierWallTimeUsage
	}
	return 0
}

func (x *Status_Run) GetVerifierMemoryUsage() uint64 {
	if x != nil {
		return x.VerifierMemoryUsage
	}
	return 0
}

func (x *Status_Run) GetVerifierExitCode() uint32 {
	if x != nil {
		return x.VerifierExitCode
	}
	return 0
}
...
var file_eolymp_executor_status_proto_rawDesc = []byte{
	...
	0xb1, 0x0c, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x1c, 0x0a, 0x09, 0x72, 0x65,
	...
	0x74, 0x1a, 0xd9, 0x09, 0x0a, 0x03, 0x52, 0x75, 0x6e, 0x12, 0x1c, 0x0a, 0x09, 0x72, 0x65, 0x66,
	...
	,
	...
	,
