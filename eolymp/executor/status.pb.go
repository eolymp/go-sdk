...
const (
	...
	Status_Run_OVERFLOW             Status_Run_Status = 4  // memory limit reached
	Status_Run_RUNTIME_ERROR        Status_Run_Status = 5  // executed, but exit code was non-zero
	Status_Run_EXECUTED             Status_Run_Status = 6  // executed (it is a final status for tasks without verifier)
	Status_Run_ACCEPTED             Status_Run_Status = 7  // executed and output matched answer
	Status_Run_WRONG_ANSWER         Status_Run_Status = 8  // executed, but output didn't match answer
	Status_Run_VERIFICATION_FAILURE Status_Run_Status = 9  // executed, but verifier returned an error during execution (use verifier_log to learn more about failure)
	Status_Run_SKIPPED              Status_Run_Status = 10 // run won't be executed due to overall timeout, or too many errors
)
...
type Status_Run struct {
	...
	TimeUsage   int32             `protobuf:"varint,4,opt,name=time_usage,json=timeUsage,proto3" json:"time_usage,omitempty"`                 // time usage in milliseconds
	MemoryUsage int32             `protobuf:"varint,5,opt,name=memory_usage,json=memoryUsage,proto3" json:"memory_usage,omitempty"`           // memory usage in bytes
	ExitCode    int32             `protobuf:"varint,6,opt,name=exit_code,json=exitCode,proto3" json:"exit_code,omitempty"`                    // program exit code
	Signal      int32             `protobuf:"varint,7,opt,name=signal,proto3" json:"signal,omitempty"`                                        // might contain signal used to kill program
	// output data
...
func (x *Status_Run) GetTimeUsage() int32 {
	if x != nil {
		return x.TimeUsage
	}
	return 0
...
var file_eolymp_executor_status_proto_rawDesc = []byte{
	...
	0xf2, 0x06, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x1c, 0x0a, 0x09, 0x72, 0x65,
	...
	0x74, 0x1a, 0x9a, 0x04, 0x0a, 0x03, 0x52, 0x75, 0x6e, 0x12, 0x1c, 0x0a, 0x09, 0x72, 0x65, 0x66,
	...
	0x28, 0x02, 0x52, 0x05, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x74, 0x69, 0x6d,
	0x65, 0x5f, 0x75, 0x73, 0x61, 0x67, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x05, 0x52, 0x09, 0x74,
	...
	,
	...
	,
