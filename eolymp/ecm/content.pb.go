...
func (x *Content) GetHtml() string {
	if x, ok := x.GetContent().(*Content_Html); ok {
		return x.Html
	}
	return ""
}
...
func (x *Content) GetLatex() string {
	if x, ok := x.GetContent().(*Content_Latex); ok {
		return x.Latex
	}
	return ""
}
...
func (x *Content) GetMarkdown() string {
	if x, ok := x.GetContent().(*Content_Markdown); ok {
		return x.Markdown
	}
	return ""
}
...
func (x *Content) GetEcm() *Node {
	if x, ok := x.GetContent().(*Content_Ecm); ok {
		return x.Ecm
	}
	return nil
}
...
func (*Content_Html) isContent_Content() {}

func (*Content_Latex) isContent_Content() {}

func (*Content_Markdown) isContent_Content() {}

func (*Content_Ecm) isContent_Content() {}
...
var file_eolymp_ecm_content_proto_rawDesc = []byte{
	...
	0x63, 0x6d, 0x2f, 0x6e, 0x6f, 0x64, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x86, 0x01,
	...
	0x4e, 0x6f, 0x64, 0x65, 0x48, 0x00, 0x52, 0x03, 0x65, 0x63, 0x6d, 0x42, 0x09, 0x0a, 0x07, 0x63,
	0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x42, 0x29, 0x5a, 0x27, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
	0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x65, 0x6f, 0x6c, 0x79, 0x6d, 0x70, 0x2f, 0x67, 0x6f, 0x2d, 0x73,
	0x64, 0x6b, 0x2f, 0x65, 0x6f, 0x6c, 0x79, 0x6d, 0x70, 0x2f, 0x65, 0x63, 0x6d, 0x3b, 0x65, 0x63,
...
var file_eolymp_ecm_content_proto_goTypes = []interface{}{
...
func file_eolymp_ecm_content_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_eolymp_ecm_content_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	file_eolymp_ecm_content_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*Content_Html)(nil),
		(*Content_Latex)(nil),
