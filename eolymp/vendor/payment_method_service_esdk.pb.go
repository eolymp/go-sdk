...
type _PaymentMethodServiceHttpClient interface {
	Do(*http.Request) (*http.Response, error)
}

type PaymentMethodServiceService struct {
	base string
	cli  _PaymentMethodServiceHttpClient
}

// NewPaymentMethodServiceHttpClient constructs client for PaymentMethodService
func NewPaymentMethodServiceHttpClient(url string, cli _PaymentMethodServiceHttpClient) *PaymentMethodServiceService {
	if url == "" {
	...
	return &PaymentMethodServiceService{base: url, cli: cli}
}

func (s *PaymentMethodServiceService) do(ctx context.Context, verb, path string, in, out proto.Message) (err error) {
	var body io.Reader
