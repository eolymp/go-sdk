...
type _ProfileServiceHttpClient interface {
	Do(*http.Request) (*http.Response, error)
}

type ProfileServiceService struct {
	base string
	cli  _ProfileServiceHttpClient
}

// NewProfileServiceHttpClient constructs client for ProfileService
func NewProfileServiceHttpClient(url string, cli _ProfileServiceHttpClient) *ProfileServiceService {
	if url == "" {
	...
	return &ProfileServiceService{base: url, cli: cli}
}

func (s *ProfileServiceService) do(ctx context.Context, verb, path string, in, out proto.Message) (err error) {
	var body io.Reader
