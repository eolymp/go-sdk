...
var file_eolymp_annotations_ratelimit_proto_rawDesc = []byte{
	...
	0x65, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x42, 0x3f, 0x5a, 0x3d, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var (
	...
	file_eolymp_annotations_ratelimit_proto_rawDescData = file_eolymp_annotations_ratelimit_proto_rawDesc
)

func file_eolymp_annotations_ratelimit_proto_rawDescGZIP() []byte {
	file_eolymp_annotations_ratelimit_proto_rawDescOnce.Do(func() {
		file_eolymp_annotations_ratelimit_proto_rawDescData = protoimpl.X.CompressGZIP(file_eolymp_annotations_ratelimit_proto_rawDescData)
	})
...
var file_eolymp_annotations_ratelimit_proto_goTypes = []interface{}{
...
func file_eolymp_annotations_ratelimit_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_eolymp_annotations_ratelimit_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_eolymp_annotations_ratelimit_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 1,
			NumServices:   0,
	...
	file_eolymp_annotations_ratelimit_proto_rawDesc = nil
