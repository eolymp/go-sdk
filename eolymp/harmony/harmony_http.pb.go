...
func _Harmony_HTTPWriteResponse(w http.ResponseWriter, v proto.Message, h, t metadata.MD) {
...
func _Harmony_ListAgreements_Rule0(cli HarmonyClient) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		out, err := cli.ListAgreements(r.Context(), in, grpc.Header(&header), grpc.Trailer(&trailer))
		if err != nil {
			_Harmony_HTTPWriteErrorResponse(w, err)
			return
		}

		_Harmony_HTTPWriteResponse(w, out, header, trailer)
	})
}
...
func _Harmony_GetConsent_Rule0(cli HarmonyClient) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		out, err := cli.GetConsent(r.Context(), in, grpc.Header(&header), grpc.Trailer(&trailer))
		if err != nil {
			_Harmony_HTTPWriteErrorResponse(w, err)
			return
		}
...
func _Harmony_SetConsent_Rule0(cli HarmonyClient) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		out, err := cli.SetConsent(r.Context(), in, grpc.Header(&header), grpc.Trailer(&trailer))
		if err != nil {
			_Harmony_HTTPWriteErrorResponse(w, err)
			return
		}
...
func _Harmony_FollowShortcut_Rule0(cli HarmonyClient) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		out, err := cli.FollowShortcut(r.Context(), in, grpc.Header(&header), grpc.Trailer(&trailer))
		if err != nil {
			_Harmony_HTTPWriteErrorResponse(w, err)
			return
		}
