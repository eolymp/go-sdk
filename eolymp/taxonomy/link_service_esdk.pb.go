...
type _LinkServiceHttpClient interface {
	Do(*http.Request) (*http.Response, error)
}

type LinkServiceService struct {
	base string
	cli  _LinkServiceHttpClient
}
...
func NewLinkServiceHttpClient(url string, cli _LinkServiceHttpClient) *LinkServiceService {
	...
	return &LinkServiceService{base: url, cli: cli}
}

func (s *LinkServiceService) do(ctx context.Context, verb, path string, in, out proto.Message) (err error) {
	var body io.Reader
