...
func file_eolymp_taxonomy_enum_value_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_eolymp_taxonomy_enum_value_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Value); i {
			case 0:
				return &v.state
			case 1:
		...
		file_eolymp_taxonomy_enum_value_proto_msgTypes[1].Exporter = func(v any, i int) any {
