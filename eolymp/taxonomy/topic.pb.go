...
type Topic struct {
	...
	Descriptors []*Topic_Descriptor `protobuf:"bytes,2,rep,name=descriptors,proto3" json:"descriptors,omitempty"`
}
...
func (x *Topic) GetDescriptors() []*Topic_Descriptor {
	if x != nil {
...
func (x *Topic_Descriptor) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Topic_Descriptor) ProtoMessage() {}

func (x *Topic_Descriptor) ProtoReflect() protoreflect.Message {
	mi := &file_eolymp_taxonomy_topic_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Topic_Descriptor.ProtoReflect.Descriptor instead.
func (*Topic_Descriptor) Descriptor() ([]byte, []int) {
	return file_eolymp_taxonomy_topic_proto_rawDescGZIP(), []int{0, 0}
}

func (x *Topic_Descriptor) GetLocale() string {
	if x != nil {
		return x.Locale
	}
	return ""
...
func (x *Topic_Descriptor) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *Topic_Descriptor) GetSummary() string {
	if x != nil {
		return x.Summary
	}
	return ""
...
func (x *Topic_Descriptor) GetKeywords() []string {
	if x != nil {
		return x.Keywords
	}
	return nil
...
var file_eolymp_taxonomy_topic_proto_rawDesc = []byte{
	...
	,
	...
	0x79, 0x12, 0x1a, 0x0a, 0x08, 0x6b, 0x65, 0x79, 0x77, 0x6f, 0x72, 0x64, 0x73, 0x18, 0x04, 0x20,
	0x03, 0x28, 0x09, 0x52, 0x08, 0x6b, 0x65, 0x79, 0x77, 0x6f, 0x72, 0x64, 0x73, 0x42, 0x33, 0x5a,
...
var file_eolymp_taxonomy_topic_proto_goTypes = []interface{}{
	...
	(*Topic_Descriptor)(nil), // 1: eolymp.taxonomy.Topic.Descriptor
}
var file_eolymp_taxonomy_topic_proto_depIdxs = []int32{
	1, // 0: eolymp.taxonomy.Topic.descriptors:type_name -> eolymp.taxonomy.Topic.Descriptor
