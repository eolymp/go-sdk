...
var file_eolymp_rating_rating_proto_rawDesc = []byte{
	...
	0x6c, 0x75, 0x65, 0x42, 0x2f, 0x5a, 0x2d, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
	0x6d, 0x2f, 0x65, 0x6f, 0x6c, 0x79, 0x6d, 0x70, 0x2f, 0x67, 0x6f, 0x2d, 0x73, 0x64, 0x6b, 0x2f,
	0x65, 0x6f, 0x6c, 0x79, 0x6d, 0x70, 0x2f, 0x72, 0x61, 0x74, 0x69, 0x6e, 0x67, 0x3b, 0x72, 0x61,
...
func file_eolymp_rating_rating_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_eolymp_rating_rating_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Rating); i {
			case 0:
				return &v.state
			case 1:
