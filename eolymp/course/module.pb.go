...
type Module struct {
	...
	Weight         bool                   `protobuf:"varint,8,opt,name=weight,proto3" json:"weight,omitempty"` // weight of the module when calculating course score
...
var file_eolymp_course_module_proto_rawDesc = []byte{
	...
	0x16, 0x0a, 0x06, 0x77, 0x65, 0x69, 0x67, 0x68, 0x74, 0x18, 0x08, 0x20, 0x01, 0x28, 0x08, 0x52,
