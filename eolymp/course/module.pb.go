...
type Module struct {
	...
	Weight         uint32                 `protobuf:"varint,8,opt,name=weight,proto3" json:"weight,omitempty"` // weight of the module when calculating course score
...
func (x *Module) GetWeight() uint32 {
	if x != nil {
		return x.Weight
	}
	return 0
