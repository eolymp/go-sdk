...
type LookupStatementOutput struct {
	...
	Statement []*atlas.Statement `protobuf:"bytes,2,rep,name=statement,proto3" json:"statement,omitempty"`
}
...
var file_eolymp_course_problem_service_proto_rawDesc = []byte{
	...
	0x65, 0x6d, 0x65, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x65, 0x6f,
