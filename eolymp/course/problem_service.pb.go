...
var file_eolymp_course_problem_service_proto_rawDesc = []byte{
	...
	0x69, 0x74, 0x65, 0x6d, 0x73, 0x32, 0x95, 0x0d, 0x0a, 0x0e, 0x50, 0x72, 0x6f, 0x62, 0x6c, 0x65,
	...
	0x5f, 0x69, 0x64, 0x7d, 0x2f, 0x77, 0x61, 0x74, 0x63, 0x68, 0x30, 0x01, 0x12, 0x8e, 0x01, 0x0a,
	0x0c, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x12, 0x20, 0x2e,
	...
	0x4c, 0x69, 0x73, 0x74, 0x52, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x4f, 0x75, 0x74, 0x70,
	0x75, 0x74, 0x22, 0x39, 0xea, 0xe2, 0x0a, 0x0b, 0xf5, 0xe2, 0x0a, 0x00, 0x00, 0xa0, 0x40, 0xf8,
	0xe2, 0x0a, 0x19, 0x82, 0xe3, 0x0a, 0x16, 0x8a, 0xe3, 0x0a, 0x12, 0x63, 0x6f, 0x75, 0x72, 0x73,
	0x65, 0x3a, 0x63, 0x6f, 0x75, 0x72, 0x73, 0x65, 0x3a, 0x72, 0x65, 0x61, 0x64, 0x82, 0xd3, 0xe4,
	0x93, 0x02, 0x0a, 0x12, 0x08, 0x2f, 0x72, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x42, 0x2f, 0x5a,
...
var file_eolymp_course_problem_service_proto_goTypes = []any{
	...
	(*LookupCodeTemplateInput)(nil),  // 4: eolymp.course.LookupCodeTemplateInput
	(*LookupCodeTemplateOutput)(nil), // 5: eolymp.course.LookupCodeTemplateOutput
	(*CreateRunInput)(nil),           // 6: eolymp.course.CreateRunInput
	(*CreateRunOutput)(nil),          // 7: eolymp.course.CreateRunOutput
	(*DescribeRunInput)(nil),         // 8: eolymp.course.DescribeRunInput
	(*DescribeRunOutput)(nil),        // 9: eolymp.course.DescribeRunOutput
	(*WatchRunInput)(nil),            // 10: eolymp.course.WatchRunInput
	(*WatchRunOutput)(nil),           // 11: eolymp.course.WatchRunOutput
	...
	(*atlas.Test)(nil),               // 15: eolymp.atlas.Test
	(*atlas.Template)(nil),           // 16: eolymp.atlas.Template
	(*playground.Run)(nil),           // 17: eolymp.playground.Run
	(*runtime.Runtime)(nil),          // 18: eolymp.runtime.Runtime
	(*CreateSubmissionInput)(nil),    // 19: eolymp.course.CreateSubmissionInput
	(*ListSubmissionsInput)(nil),     // 20: eolymp.course.ListSubmissionsInput
	(*DescribeSubmissionInput)(nil),  // 21: eolymp.course.DescribeSubmissionInput
	(*WatchSubmissionInput)(nil),     // 22: eolymp.course.WatchSubmissionInput
	(*CreateSubmissionOutput)(nil),   // 23: eolymp.course.CreateSubmissionOutput
	(*ListSubmissionsOutput)(nil),    // 24: eolymp.course.ListSubmissionsOutput
	(*DescribeSubmissionOutput)(nil), // 25: eolymp.course.DescribeSubmissionOutput
	(*WatchSubmissionOutput)(nil),    // 26: eolymp.course.WatchSubmissionOutput
}
var file_eolymp_course_problem_service_proto_depIdxs = []int32{
	...
	15, // 1: eolymp.course.ListExamplesOutput.examples:type_name -> eolymp.atlas.Test
	16, // 2: eolymp.course.LookupCodeTemplateOutput.template:type_name -> eolymp.atlas.Template
	17, // 3: eolymp.course.DescribeRunOutput.run:type_name -> eolymp.playground.Run
	17, // 4: eolymp.course.WatchRunOutput.run:type_name -> eolymp.playground.Run
	18, // 5: eolymp.course.ListRuntimesOutput.items:type_name -> eolymp.runtime.Runtime
	0,  // 6: eolymp.course.ProblemService.ListStatements:input_type -> eolymp.course.ListStatementsInput
	2,  // 7: eolymp.course.ProblemService.ListExamples:input_type -> eolymp.course.ListExamplesInput
	19, // 8: eolymp.course.ProblemService.CreateSubmission:input_type -> eolymp.course.CreateSubmissionInput
	20, // 9: eolymp.course.ProblemService.ListSubmissions:input_type -> eolymp.course.ListSubmissionsInput
	21, // 10: eolymp.course.ProblemService.DescribeSubmission:input_type -> eolymp.course.DescribeSubmissionInput
	22, // 11: eolymp.course.ProblemService.WatchSubmission:input_type -> eolymp.course.WatchSubmissionInput
	4,  // 12: eolymp.course.ProblemService.LookupCodeTemplate:input_type -> eolymp.course.LookupCodeTemplateInput
	6,  // 13: eolymp.course.ProblemService.CreateRun:input_type -> eolymp.course.CreateRunInput
	8,  // 14: eolymp.course.ProblemService.DescribeRun:input_type -> eolymp.course.DescribeRunInput
	10, // 15: eolymp.course.ProblemService.WatchRun:input_type -> eolymp.course.WatchRunInput
	12, // 16: eolymp.course.ProblemService.ListRuntimes:input_type -> eolymp.course.ListRuntimesInput
	1,  // 17: eolymp.course.ProblemService.ListStatements:output_type -> eolymp.course.ListStatementsOutput
	3,  // 18: eolymp.course.ProblemService.ListExamples:output_type -> eolymp.course.ListExamplesOutput
	23, // 19: eolymp.course.ProblemService.CreateSubmission:output_type -> eolymp.course.CreateSubmissionOutput
	24, // 20: eolymp.course.ProblemService.ListSubmissions:output_type -> eolymp.course.ListSubmissionsOutput
	25, // 21: eolymp.course.ProblemService.DescribeSubmission:output_type -> eolymp.course.DescribeSubmissionOutput
	26, // 22: eolymp.course.ProblemService.WatchSubmission:output_type -> eolymp.course.WatchSubmissionOutput
	5,  // 23: eolymp.course.ProblemService.LookupCodeTemplate:output_type -> eolymp.course.LookupCodeTemplateOutput
	7,  // 24: eolymp.course.ProblemService.CreateRun:output_type -> eolymp.course.CreateRunOutput
	9,  // 25: eolymp.course.ProblemService.DescribeRun:output_type -> eolymp.course.DescribeRunOutput
	11, // 26: eolymp.course.ProblemService.WatchRun:output_type -> eolymp.course.WatchRunOutput
	13, // 27: eolymp.course.ProblemService.ListRuntimes:output_type -> eolymp.course.ListRuntimesOutput
...
func file_eolymp_course_problem_service_proto_init() {
	...
	file_eolymp_course_problem_service_proto_msgTypes[6].OneofWrappers = []any{
