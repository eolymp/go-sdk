...
func RegisterEditorServiceHttpHandlers(router *mux.Router, prefix string, cli EditorServiceClient) {
	router.Handle(prefix+"/courses/{course_id}/materials/{material_id}/editor", _EditorService_DescribeEditor_Rule0(cli)).
		Methods("GET").
		Name("eolymp.course.EditorService.DescribeEditor")
	router.Handle(prefix+"/courses/{course_id}/materials/{material_id}/editor/state", _EditorService_DescribeEditorState_Rule0(cli)).
		Methods("GET").
		Name("eolymp.course.EditorService.DescribeEditorState")
	router.Handle(prefix+"/courses/{course_id}/materials/{material_id}/editor/state", _EditorService_UpdateEditorState_Rule0(cli)).
		Methods("POST").
		Name("eolymp.course.EditorService.UpdateEditorState")
	router.Handle(prefix+"/courses/{course_id}/materials/{material_id}/inputs", _EditorService_ListInputs_Rule0(cli)).
		Methods("GET").
		Name("eolymp.course.EditorService.ListInputs")
}
