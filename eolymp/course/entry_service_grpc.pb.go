...
func (c *entryServiceClient) RenameEntry(ctx context.Context, in *RenameEntryInput, opts ...grpc.CallOption) (*RenameEntryOutput, error) {
	...
	err := c.cc.Invoke(ctx, EntryService_RenameEntry_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *entryServiceClient) MoveEntry(ctx context.Context, in *MoveEntryInput, opts ...grpc.CallOption) (*MoveEntryOutput, error) {
	...
	err := c.cc.Invoke(ctx, EntryService_MoveEntry_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *entryServiceClient) DescribeEntry(ctx context.Context, in *DescribeEntryInput, opts ...grpc.CallOption) (*DescribeEntryOutput, error) {
	...
	err := c.cc.Invoke(ctx, EntryService_DescribeEntry_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *entryServiceClient) DescribeTree(ctx context.Context, in *DescribeTreeInput, opts ...grpc.CallOption) (*DescribeTreeOutput, error) {
	...
	err := c.cc.Invoke(ctx, EntryService_DescribeTree_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *entryServiceClient) ListParents(ctx context.Context, in *ListParentsInput, opts ...grpc.CallOption) (*ListParentsOutput, error) {
	...
	err := c.cc.Invoke(ctx, EntryService_ListParents_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
