...
const (
	...
	Course_ASSIGNMENT         Course_Extra = 3
)
...
type Course_ParticipationMode int32

const (
	Course_UNKNOWN_PARTICIPATION_MODE Course_ParticipationMode = 0
	Course_SELF_PACED                 Course_ParticipationMode = 1 // participants can access all lessons
	Course_MODERATED                  Course_ParticipationMode = 2 // admin has to assign lessons one by one
)

// Enum value maps for Course_ParticipationMode.
var (
	Course_ParticipationMode_name = map[int32]string{
		0: "UNKNOWN_PARTICIPATION_MODE",
		1: "SELF_PACED",
		2: "MODERATED",
	}
	Course_ParticipationMode_value = map[string]int32{
		"UNKNOWN_PARTICIPATION_MODE": 0,
		"SELF_PACED":                 1,
		"MODERATED":                  2,
	}
)

func (x Course_ParticipationMode) Enum() *Course_ParticipationMode {
	p := new(Course_ParticipationMode)
	*p = x
	return p
}

func (x Course_ParticipationMode) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Course_ParticipationMode) Descriptor() protoreflect.EnumDescriptor {
	return file_eolymp_course_course_proto_enumTypes[2].Descriptor()
}

func (Course_ParticipationMode) Type() protoreflect.EnumType {
	return &file_eolymp_course_course_proto_enumTypes[2]
}

func (x Course_ParticipationMode) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Course_ParticipationMode.Descriptor instead.
func (Course_ParticipationMode) EnumDescriptor() ([]byte, []int) {
	return file_eolymp_course_course_proto_rawDescGZIP(), []int{0, 2}
}
...
type Course struct {
	...
	ParticipationMode Course_ParticipationMode `protobuf:"varint,30,opt,name=participation_mode,json=participationMode,proto3,enum=eolymp.course.Course_ParticipationMode" json:"participation_mode,omitempty"`
	// Assignment status
	Assignment *Assignment `protobuf:"bytes,100,opt,name=assignment,proto3" json:"assignment,omitempty"`
}
...
func (x *Course) GetParticipationMode() Course_ParticipationMode {
	if x != nil {
		return x.ParticipationMode
	}
	return Course_UNKNOWN_PARTICIPATION_MODE
}

func (x *Course) GetAssignment() *Assignment {
	if x != nil {
		return x.Assignment
	}
	return nil
...
var file_eolymp_course_course_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc4, 0x05, 0x0a, 0x06, 0x43, 0x6f, 0x75, 0x72, 0x73, 0x65,
	...
	0x01, 0x28, 0x0d, 0x52, 0x08, 0x65, 0x73, 0x74, 0x69, 0x6d, 0x61, 0x74, 0x65, 0x12, 0x56, 0x0a,
	0x12, 0x70, 0x61, 0x72, 0x74, 0x69, 0x63, 0x69, 0x70, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x6d,
	0x6f, 0x64, 0x65, 0x18, 0x1e, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x27, 0x2e, 0x65, 0x6f, 0x6c, 0x79,
	0x6d, 0x70, 0x2e, 0x63, 0x6f, 0x75, 0x72, 0x73, 0x65, 0x2e, 0x43, 0x6f, 0x75, 0x72, 0x73, 0x65,
	...
	0x6e, 0x4d, 0x6f, 0x64, 0x65, 0x12, 0x39, 0x0a, 0x0a, 0x61, 0x73, 0x73, 0x69, 0x67, 0x6e, 0x6d,
	0x65, 0x6e, 0x74, 0x18, 0x64, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x65, 0x6f, 0x6c, 0x79,
	...
	0x22, 0x59, 0x0a, 0x05, 0x45, 0x78, 0x74, 0x72, 0x61, 0x12, 0x11, 0x0a, 0x0d, 0x55, 0x4e, 0x4b,
	...
	0x4f, 0x4e, 0x5f, 0x52, 0x45, 0x4e, 0x44, 0x45, 0x52, 0x10, 0x02, 0x12, 0x0e, 0x0a, 0x0a, 0x41,
	0x53, 0x53, 0x49, 0x47, 0x4e, 0x4d, 0x45, 0x4e, 0x54, 0x10, 0x03, 0x22, 0x4b, 0x0a, 0x0a, 0x56,
	...
	0x52, 0x49, 0x56, 0x41, 0x54, 0x45, 0x10, 0x03, 0x22, 0x52, 0x0a, 0x11, 0x50, 0x61, 0x72, 0x74,
	0x69, 0x63, 0x69, 0x70, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x4d, 0x6f, 0x64, 0x65, 0x12, 0x1e, 0x0a,
	0x1a, 0x55, 0x4e, 0x4b, 0x4e, 0x4f, 0x57, 0x4e, 0x5f, 0x50, 0x41, 0x52, 0x54, 0x49, 0x43, 0x49,
	0x50, 0x41, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x4d, 0x4f, 0x44, 0x45, 0x10, 0x00, 0x12, 0x0e, 0x0a,
	0x0a, 0x53, 0x45, 0x4c, 0x46, 0x5f, 0x50, 0x41, 0x43, 0x45, 0x44, 0x10, 0x01, 0x12, 0x0d, 0x0a,
	0x09, 0x4d, 0x4f, 0x44, 0x45, 0x52, 0x41, 0x54, 0x45, 0x44, 0x10, 0x02, 0x42, 0x2f, 0x5a, 0x2d,
...
var file_eolymp_course_course_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
...
var file_eolymp_course_course_proto_goTypes = []interface{}{
	...
	(Course_ParticipationMode)(0), // 2: eolymp.course.Course.ParticipationMode
	(*Course)(nil),                // 3: eolymp.course.Course
...
var file_eolymp_course_course_proto_depIdxs = []int32{
	...
	2, // 2: eolymp.course.Course.participation_mode:type_name -> eolymp.course.Course.ParticipationMode
	5, // 3: eolymp.course.Course.assignment:type_name -> eolymp.course.Assignment
