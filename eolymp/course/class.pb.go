...
const file_eolymp_course_class_proto_rawDesc = "" +
	"\n" +
	"\x19eolymp/course/class.proto\x12\reolymp.course\"U\n" +
	"\x05Class\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x19\n" +
	"\bgroup_id\x18\x03 \x01(\tR\agroupId\x12!\n" +
	"\fmodule_count\x18\x06 \x01(\rR\vmoduleCountB/Z-github.com/eolymp/go-sdk/eolymp/course;courseb\x06proto3"

var (
	file_eolymp_course_class_proto_rawDescOnce sync.Once
	file_eolymp_course_class_proto_rawDescData []byte
)

func file_eolymp_course_class_proto_rawDescGZIP() []byte {
	file_eolymp_course_class_proto_rawDescOnce.Do(func() {
		file_eolymp_course_class_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_eolymp_course_class_proto_rawDesc), len(file_eolymp_course_class_proto_rawDesc)))
	})
...
func file_eolymp_course_class_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_eolymp_course_class_proto_rawDesc), len(file_eolymp_course_class_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
