...
type Assignment struct {
	...
	Modules        []*Assignment_Module   `protobuf:"bytes,30,rep,name=modules,proto3" json:"modules,omitempty"`
...
func (x *Assignment) GetModules() []*Assignment_Module {
	if x != nil {
		return x.Modules
	}
	return nil
...
type Assignment_Module struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	ModuleId string             `protobuf:"bytes,1,opt,name=module_id,json=moduleId,proto3" json:"module_id,omitempty"`
	Items    []*Assignment_Item `protobuf:"bytes,2,rep,name=items,proto3" json:"items,omitempty"`
}

func (x *Assignment_Module) Reset() {
	*x = Assignment_Module{}
	if protoimpl.UnsafeEnabled {
		mi := &file_eolymp_course_assignment_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *Assignment_Module) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Assignment_Module) ProtoMessage() {}

func (x *Assignment_Module) ProtoReflect() protoreflect.Message {
	mi := &file_eolymp_course_assignment_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Assignment_Module.ProtoReflect.Descriptor instead.
func (*Assignment_Module) Descriptor() ([]byte, []int) {
	return file_eolymp_course_assignment_proto_rawDescGZIP(), []int{0, 0}
}

func (x *Assignment_Module) GetModuleId() string {
	if x != nil {
		return x.ModuleId
	}
	return ""
...
func (x *Assignment_Module) GetItems() []*Assignment_Item {
	if x != nil {
		return x.Items
	}
	return nil
...
func (x *Assignment_Item) Reset() {
	*x = Assignment_Item{}
	if protoimpl.UnsafeEnabled {
		mi := &file_eolymp_course_assignment_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *Assignment_Item) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Assignment_Item) ProtoMessage() {}

func (x *Assignment_Item) ProtoReflect() protoreflect.Message {
	mi := &file_eolymp_course_assignment_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Assignment_Item.ProtoReflect.Descriptor instead.
func (*Assignment_Item) Descriptor() ([]byte, []int) {
	return file_eolymp_course_assignment_proto_rawDescGZIP(), []int{0, 1}
}

func (x *Assignment_Item) GetItemId() string {
	if x != nil {
		return x.ItemId
	}
	return ""
...
var file_eolymp_course_assignment_proto_rawDesc = []byte{
	...
	0x22, 0xb6, 0x06, 0x0a, 0x0a, 0x41, 0x73, 0x73, 0x69, 0x67, 0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x12,
	...
	0x48, 0x00, 0x52, 0x07, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x49, 0x64, 0x12, 0x3a, 0x0a, 0x07, 0x6d,
	0x6f, 0x64, 0x75, 0x6c, 0x65, 0x73, 0x18, 0x1e, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x65,
	0x6f, 0x6c, 0x79, 0x6d, 0x70, 0x2e, 0x63, 0x6f, 0x75, 0x72, 0x73, 0x65, 0x2e, 0x41, 0x73, 0x73,
	0x69, 0x67, 0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x4d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x52, 0x07,
	0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x73, 0x12, 0x38, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75,
	...
	0x61, 0x72, 0x74, 0x65, 0x64, 0x5f, 0x61, 0x74, 0x18, 0x19, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a,
	...
	,
	...
	0x12, 0x0b, 0x0a, 0x07, 0x55, 0x50, 0x53, 0x4f, 0x4c, 0x56, 0x45, 0x10, 0x07, 0x42, 0x0a, 0x0a,
...
var file_eolymp_course_assignment_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_eolymp_course_assignment_proto_goTypes = []any{
	...
	(*Assignment_Module)(nil),     // 3: eolymp.course.Assignment.Module
	(*Assignment_Item)(nil),       // 4: eolymp.course.Assignment.Item
	(*timestamppb.Timestamp)(nil), // 5: google.protobuf.Timestamp
}
var file_eolymp_course_assignment_proto_depIdxs = []int32{
	3, // 0: eolymp.course.Assignment.modules:type_name -> eolymp.course.Assignment.Module
	1, // 1: eolymp.course.Assignment.status:type_name -> eolymp.course.Assignment.Status
	5, // 2: eolymp.course.Assignment.start_after:type_name -> google.protobuf.Timestamp
	5, // 3: eolymp.course.Assignment.complete_before:type_name -> google.protobuf.Timestamp
	5, // 4: eolymp.course.Assignment.created_at:type_name -> google.protobuf.Timestamp
	5, // 5: eolymp.course.Assignment.started_at:type_name -> google.protobuf.Timestamp
	5, // 6: eolymp.course.Assignment.completed_at:type_name -> google.protobuf.Timestamp
	4, // 7: eolymp.course.Assignment.Module.items:type_name -> eolymp.course.Assignment.Item
...
func file_eolymp_course_assignment_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_eolymp_course_assignment_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Assignment_Module); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_eolymp_course_assignment_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Assignment_Item); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
