...
// _WebhookService_WebsocketErrorResponse writes error to websocket connection
func _WebhookService_WebsocketErrorResponse(conn *websocket.Conn, e error) {
...
// _WebhookService_WebsocketCodec implements protobuf codec for websockets package
var _WebhookService_WebsocketCodec = websocket.Codec{
