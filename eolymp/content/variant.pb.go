...
var file_eolymp_content_variant_proto_rawDesc = []byte{
	...
	0x6e, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb4, 0x01, 0x0a, 0x07, 0x56, 0x61, 0x72,
	...
	0x43, 0x4f, 0x4e, 0x54, 0x45, 0x4e, 0x54, 0x5f, 0x56, 0x41, 0x4c, 0x55, 0x45, 0x10, 0x02, 0x42,
...
var (
	...
	file_eolymp_content_variant_proto_rawDescData = file_eolymp_content_variant_proto_rawDesc
)

func file_eolymp_content_variant_proto_rawDescGZIP() []byte {
	file_eolymp_content_variant_proto_rawDescOnce.Do(func() {
		file_eolymp_content_variant_proto_rawDescData = protoimpl.X.CompressGZIP(file_eolymp_content_variant_proto_rawDescData)
	})
...
var file_eolymp_content_variant_proto_goTypes = []interface{}{
...
func file_eolymp_content_variant_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_eolymp_content_variant_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_eolymp_content_variant_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_eolymp_content_variant_proto_rawDesc = nil
