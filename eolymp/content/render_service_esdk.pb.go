...
type _RenderServiceHttpClient interface {
	Do(*http.Request) (*http.Response, error)
}

type RenderServiceService struct {
	base string
	cli  _RenderServiceHttpClient
}
...
func NewRenderServiceHttpClient(url string, cli _RenderServiceHttpClient) *RenderServiceService {
	...
	return &RenderServiceService{base: url, cli: cli}
}

func (s *RenderServiceService) do(ctx context.Context, verb, path string, in, out proto.Message) (err error) {
	var body io.Reader
