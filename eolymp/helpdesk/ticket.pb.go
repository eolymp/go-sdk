...
type Ticket struct {
	...
	//	*Ticket_MessageHtml
	//	*Ticket_MessageLatex
	//	*Ticket_MessageMarkdown
	//	*Ticket_MessageEcm
	Message isTicket_Message `protobuf_oneof:"message"`
}
...
func (m *Ticket) GetMessage() isTicket_Message {
	if m != nil {
		return m.Message
	}
	return nil
...
func (x *Ticket) GetMessageHtml() string {
	if x, ok := x.GetMessage().(*Ticket_MessageHtml); ok {
		return x.MessageHtml
	}
	return ""
}

func (x *Ticket) GetMessageLatex() string {
	if x, ok := x.GetMessage().(*Ticket_MessageLatex); ok {
		return x.MessageLatex
	}
	return ""
}

func (x *Ticket) GetMessageMarkdown() string {
	if x, ok := x.GetMessage().(*Ticket_MessageMarkdown); ok {
		return x.MessageMarkdown
	}
	return ""
}

func (x *Ticket) GetMessageEcm() *ecm.Node {
	if x, ok := x.GetMessage().(*Ticket_MessageEcm); ok {
		return x.MessageEcm
	}
	return nil
}

type isTicket_Message interface {
	isTicket_Message()
}

type Ticket_MessageHtml struct {
	MessageHtml string `protobuf:"bytes,50,opt,name=message_html,json=messageHtml,proto3,oneof"`
}

type Ticket_MessageLatex struct {
	MessageLatex string `protobuf:"bytes,51,opt,name=message_latex,json=messageLatex,proto3,oneof"`
}

type Ticket_MessageMarkdown struct {
	MessageMarkdown string `protobuf:"bytes,52,opt,name=message_markdown,json=messageMarkdown,proto3,oneof"`
}

type Ticket_MessageEcm struct {
	MessageEcm *ecm.Node `protobuf:"bytes,53,opt,name=message_ecm,json=messageEcm,proto3,oneof"`
}

func (*Ticket_MessageHtml) isTicket_Message() {}

func (*Ticket_MessageLatex) isTicket_Message() {}

func (*Ticket_MessageMarkdown) isTicket_Message() {}

func (*Ticket_MessageEcm) isTicket_Message() {}
...
type Ticket_Comment struct {
	...
	UpdatedAt *timestamppb.Timestamp `protobuf:"bytes,11,opt,name=updated_at,json=updatedAt,proto3" json:"updated_at,omitempty"`
	// Types that are assignable to Message:
	//	*Ticket_Comment_MessageHtml
	//	*Ticket_Comment_MessageLatex
	//	*Ticket_Comment_MessageMarkdown
	//	*Ticket_Comment_MessageEcm
	Message isTicket_Comment_Message `protobuf_oneof:"message"`
}
...
func (m *Ticket_Comment) GetMessage() isTicket_Comment_Message {
	if m != nil {
		return m.Message
	}
	return nil
...
func (x *Ticket_Comment) GetMessageHtml() string {
	if x, ok := x.GetMessage().(*Ticket_Comment_MessageHtml); ok {
		return x.MessageHtml
	}
	return ""
}

func (x *Ticket_Comment) GetMessageLatex() string {
	if x, ok := x.GetMessage().(*Ticket_Comment_MessageLatex); ok {
		return x.MessageLatex
	}
	return ""
}

func (x *Ticket_Comment) GetMessageMarkdown() string {
	if x, ok := x.GetMessage().(*Ticket_Comment_MessageMarkdown); ok {
		return x.MessageMarkdown
	}
	return ""
}

func (x *Ticket_Comment) GetMessageEcm() *ecm.Node {
	if x, ok := x.GetMessage().(*Ticket_Comment_MessageEcm); ok {
		return x.MessageEcm
	}
	return nil
}

type isTicket_Comment_Message interface {
	isTicket_Comment_Message()
}

type Ticket_Comment_MessageHtml struct {
	MessageHtml string `protobuf:"bytes,50,opt,name=message_html,json=messageHtml,proto3,oneof"`
}

type Ticket_Comment_MessageLatex struct {
	MessageLatex string `protobuf:"bytes,51,opt,name=message_latex,json=messageLatex,proto3,oneof"`
}

type Ticket_Comment_MessageMarkdown struct {
	MessageMarkdown string `protobuf:"bytes,52,opt,name=message_markdown,json=messageMarkdown,proto3,oneof"`
}

type Ticket_Comment_MessageEcm struct {
	MessageEcm *ecm.Node `protobuf:"bytes,53,opt,name=message_ecm,json=messageEcm,proto3,oneof"`
}

func (*Ticket_Comment_MessageHtml) isTicket_Comment_Message() {}

func (*Ticket_Comment_MessageLatex) isTicket_Comment_Message() {}

func (*Ticket_Comment_MessageMarkdown) isTicket_Comment_Message() {}

func (*Ticket_Comment_MessageEcm) isTicket_Comment_Message() {}
...
var file_eolymp_helpdesk_ticket_proto_rawDesc = []byte{
	...
	0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xda, 0x0a, 0x0a, 0x06, 0x54, 0x69, 0x63, 0x6b,
	...
	,
	...
	0x75, 0x73, 0x65, 0x72, 0x45, 0x6d, 0x61, 0x69, 0x6c, 0x12, 0x49, 0x0a, 0x08, 0x6d, 0x65, 0x74,
	0x61, 0x64, 0x61, 0x74, 0x61, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2d, 0x2e, 0x65, 0x6f,
	0x6c, 0x79, 0x6d, 0x70, 0x2e, 0x68, 0x65, 0x6c, 0x70, 0x64, 0x65, 0x73, 0x6b, 0x2e, 0x54, 0x69,
	0x63, 0x6b, 0x65, 0x74, 0x2e, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x4d, 0x65, 0x74,
	...
	,
	...
	0x0c, 0x0a, 0x08, 0x51, 0x55, 0x45, 0x53, 0x54, 0x49, 0x4f, 0x4e, 0x10, 0x01, 0x12, 0x12, 0x0a,
	0x0e, 0x51, 0x55, 0x4f, 0x54, 0x41, 0x5f, 0x49, 0x4e, 0x43, 0x52, 0x45, 0x41, 0x53, 0x45, 0x10,
	0x02, 0x12, 0x0c, 0x0a, 0x08, 0x46, 0x45, 0x45, 0x44, 0x42, 0x41, 0x43, 0x4b, 0x10, 0x03, 0x22,
	...
	0x47, 0x10, 0x01, 0x12, 0x0c, 0x0a, 0x08, 0x41, 0x57, 0x41, 0x49, 0x54, 0x49, 0x4e, 0x47, 0x10,
	0x02, 0x12, 0x0a, 0x0a, 0x06, 0x43, 0x4c, 0x4f, 0x53, 0x45, 0x44, 0x10, 0x03, 0x12, 0x0c, 0x0a,
	0x08, 0x41, 0x50, 0x50, 0x52, 0x4f, 0x56, 0x45, 0x44, 0x10, 0x04, 0x12, 0x0c, 0x0a, 0x08, 0x52,
	0x45, 0x4a, 0x45, 0x43, 0x54, 0x45, 0x44, 0x10, 0x05, 0x42, 0x09, 0x0a, 0x07, 0x6d, 0x65, 0x73,
...
var file_eolymp_helpdesk_ticket_proto_depIdxs = []int32{
	...
	7,  // 5: eolymp.helpdesk.Ticket.message_ecm:type_name -> eolymp.ecm.Node
	...
	7,  // 9: eolymp.helpdesk.Ticket.Comment.message_ecm:type_name -> eolymp.ecm.Node
...
func file_eolymp_helpdesk_ticket_proto_init() {
	...
	file_eolymp_helpdesk_ticket_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*Ticket_MessageHtml)(nil),
		(*Ticket_MessageLatex)(nil),
		(*Ticket_MessageMarkdown)(nil),
		(*Ticket_MessageEcm)(nil),
	}
	file_eolymp_helpdesk_ticket_proto_msgTypes[1].OneofWrappers = []interface{}{
		(*Ticket_Comment_MessageHtml)(nil),
		(*Ticket_Comment_MessageLatex)(nil),
		(*Ticket_Comment_MessageMarkdown)(nil),
		(*Ticket_Comment_MessageEcm)(nil),
	}
	type x struct{}
