...
type ListPoliciesInput_Filter struct {
	...
	PrincipalId   []*wellknown.ExpressionID     `protobuf:"bytes,5,rep,name=principal_id,json=principalId,proto3" json:"principal_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ListPoliciesInput_Filter) GetPrincipalId() []*wellknown.ExpressionID {
	if x != nil {
...
const file_eolymp_acl_policy_service_proto_rawDesc = "" +
	...
	"eolymp.acl\x1a\x17eolymp/acl/policy.proto\x1a\x1eeolymp/annotations/audit.proto\x1a\x1deolymp/annotations/http.proto\x1a\"eolymp/annotations/namespace.proto\x1a\"eolymp/annotations/ratelimit.proto\x1a\x1eeolymp/annotations/scope.proto\x1a!eolymp/wellknown/expression.proto\"?\n" +
	...
	"\bresource\x18\x04 \x03(\v2 .eolymp.wellknown.ExpressionEnumR\bresource\x12A\n" +
	"\fprincipal_id\x18\x05 \x03(\v2\x1e.eolymp.wellknown.ExpressionIDR\vprincipalId\"T\n" +
	...
	"\fcopies_count\x18\x01 \x01(\x05R\vcopiesCount2\xc5\a\n" +
	...
	"\x04\xa8\xe3\n" +
	"\x02\x82\xd3\xe4\x93\x02\v\"\t/policies\x12\x9b\x01\n" +
	"\fUpdatePolicy\x12\x1d.eolymp.acl.UpdatePolicyInput\x1a\x1e.eolymp.acl.UpdatePolicyOutput\"L\xea\xe2\n" +
	"\v\xf5\xe2\n" +
	"\x00\x00\xa0@\xf8\xe2\n" +
	"\x14\x82\xe3\n" +
	"\x14\x8a\xe3\n" +
	...
	"\fDeletePolicy\x12\x1d.eolymp.acl.DeletePolicyInput\x1a\x1e.eolymp.acl.DeletePolicyOutput\"L\xea\xe2\n" +
	"\v\xf5\xe2\n" +
	"\x00\x00\xa0@\xf8\xe2\n" +
	"\x14\x82\xe3\n" +
	"\x14\x8a\xe3\n" +
	...
	"\x0eDescribePolicy\x12\x1f.eolymp.acl.DescribePolicyInput\x1a .eolymp.acl.DescribePolicyOutput\"K\xea\xe2\n" +
	"\v\xf5\xe2\n" +
	"\x00\x00 A\xf8\xe2\n" +
	"\x14\x82\xe3\n" +
	"\x13\x8a\xe3\n" +
	...
	"\x0facl:policy:read\xa2\xe3\n" +
	"\x04\xa8\xe3\n" +
	"\x01\x82\xd3\xe4\x93\x02\v\x12\t/policies\x12\x94\x01\n" +
	"\fCopyPolicies\x12\x1d.eolymp.acl.CopyPoliciesInput\x1a\x1e.eolymp.acl.CopyPoliciesOutput\"E\xea\xe2\n" +
	"\v\xf5\xe2\n" +
	"\x00\x00 A\xf8\xe2\n" +
	"\x14\x82\xe3\n" +
	"\x14\x8a\xe3\n" +
	"\x10acl:policy:write\xa2\xe3\n" +
	"\x04\xa8\xe3\n" +
	"\x02\x82\xd3\xe4\x93\x02\x10\"\x0e/policies:copy\x1a\x1b\x82\xf0\xf0\xe4\x01\x15eolymp.universe.SpaceB)Z'github.com/eolymp/go-sdk/eolymp/acl;aclb\x06proto3"
