...
func file_eolymp_acl_policy_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_eolymp_acl_policy_service_proto_msgTypes[10].Exporter = func(v any, i int) any {
			switch v := v.(*CopyPoliciesInput); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_eolymp_acl_policy_service_proto_msgTypes[11].Exporter = func(v any, i int) any {
			switch v := v.(*CopyPoliciesOutput); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_eolymp_acl_policy_service_proto_msgTypes[12].Exporter = func(v any, i int) any {
