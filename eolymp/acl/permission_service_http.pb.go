...
// _PermissionService_HTTPReadQueryString parses body into proto.Message
func _PermissionService_HTTPReadQueryString(r *http.Request, v proto.Message) error {
...
// _PermissionService_HTTPReadRequestBody parses body into proto.Message
func _PermissionService_HTTPReadRequestBody(r *http.Request, v proto.Message) error {
...
// _PermissionService_WebsocketErrorResponse writes error to websocket connection
func _PermissionService_WebsocketErrorResponse(conn *websocket.Conn, e error) {
...
// _PermissionService_WebsocketCodec implements protobuf codec for websockets package
var _PermissionService_WebsocketCodec = websocket.Codec{
...
func _PermissionService_IntrospectPermissions_Rule0(cli PermissionServiceClient) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if err := _PermissionService_HTTPReadRequestBody(r, in); err != nil {
