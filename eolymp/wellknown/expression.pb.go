...
const file_eolymp_wellknown_expression_proto_rawDesc = "" +
	"\n" +
	"!eolymp/wellknown/expression.proto\x12\x10eolymp.wellknown\x1a\x1fgoogle/protobuf/timestamp.proto\"\x85\x01\n" +
	"\fExpressionID\x123\n" +
	"\x02is\x18\x01 \x01(\x0e2#.eolymp.wellknown.ExpressionID.TypeR\x02is\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value\"*\n" +
	"\x04Type\x12\b\n" +
	"\x04NONE\x10\x00\x12\t\n" +
	"\x05EQUAL\x10\x01\x12\r\n" +
	"\tNOT_EQUAL\x10\x02\"\xd5\x01\n" +
	"\rExpressionInt\x124\n" +
	"\x02is\x18\x01 \x01(\x0e2$.eolymp.wellknown.ExpressionInt.TypeR\x02is\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x05R\x05value\"x\n" +
	"\x04Type\x12\b\n" +
	"\x04NONE\x10\x00\x12\t\n" +
	"\x05EQUAL\x10\x01\x12\r\n" +
	...
	"\x0fLESS_THAN_EQUAL\x10\x06\"\xd9\x01\n" +
	"\x0fExpressionFloat\x126\n" +
	"\x02is\x18\x01 \x01(\x0e2&.eolymp.wellknown.ExpressionFloat.TypeR\x02is\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x02R\x05value\"x\n" +
	"\x04Type\x12\b\n" +
	"\x04NONE\x10\x00\x12\t\n" +
	"\x05EQUAL\x10\x01\x12\r\n" +
	"\tNOT_EQUAL\x10\x02\x12\x10\n" +
	...
	"\x12GREATER_THAN_EQUAL\x10\x04\x12\r\n" +
	"\tLESS_THAN\x10\x05\x12\x13\n" +
	"\x0fLESS_THAN_EQUAL\x10\x06\"\xab\x01\n" +
	"\x10ExpressionString\x127\n" +
	"\x02is\x18\x01 \x01(\x0e2'.eolymp.wellknown.ExpressionString.TypeR\x02is\x12\x14\n" +
	...
	"\n" +
	"CONTAINING\x10\x03\x12\f\n" +
	"\bSTARTING\x10\x04\"\x89\x01\n" +
	"\x0eExpressionEnum\x125\n" +
	"\x02is\x18\x01 \x01(\x0e2%.eolymp.wellknown.ExpressionEnum.TypeR\x02is\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value\"*\n" +
	"\x04Type\x12\b\n" +
	"\x04NONE\x10\x00\x12\t\n" +
	"\x05EQUAL\x10\x01\x12\r\n" +
	"\tNOT_EQUAL\x10\x02\"z\n" +
	"\x0eExpressionBool\x125\n" +
	"\x02is\x18\x01 \x01(\x0e2%.eolymp.wellknown.ExpressionBool.TypeR\x02is\x12\x14\n" +
	"\x05value\x18\x02 \x01(\bR\x05value\"\x1b\n" +
	"\x04Type\x12\b\n" +
	"\x04NONE\x10\x00\x12\t\n" +
	"\x05EQUAL\x10\x01\"\xfd\x01\n" +
	"\x13ExpressionTimestamp\x12:\n" +
	"\x02is\x18\x01 \x01(\x0e2*.eolymp.wellknown.ExpressionTimestamp.TypeR\x02is\x120\n" +
	"\x05value\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\x05value\"x\n" +
	"\x04Type\x12\b\n" +
	"\x04NONE\x10\x00\x12\t\n" +
	"\x05EQUAL\x10\x01\x12\r\n" +
	"\tNOT_EQUAL\x10\x02\x12\x10\n" +
	...
	"\x12GREATER_THAN_EQUAL\x10\x04\x12\r\n" +
	"\tLESS_THAN\x10\x05\x12\x13\n" +
	"\x0fLESS_THAN_EQUAL\x10\x06B5Z3github.com/eolymp/go-sdk/eolymp/wellknown;wellknownb\x06proto3"

var (
	file_eolymp_wellknown_expression_proto_rawDescOnce sync.Once
	file_eolymp_wellknown_expression_proto_rawDescData []byte
)

func file_eolymp_wellknown_expression_proto_rawDescGZIP() []byte {
	file_eolymp_wellknown_expression_proto_rawDescOnce.Do(func() {
		file_eolymp_wellknown_expression_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_eolymp_wellknown_expression_proto_rawDesc), len(file_eolymp_wellknown_expression_proto_rawDesc)))
	})
...
var file_eolymp_wellknown_expression_proto_goTypes = []any{
...
func file_eolymp_wellknown_expression_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_eolymp_wellknown_expression_proto_rawDesc), len(file_eolymp_wellknown_expression_proto_rawDesc)),
			NumEnums:      7,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
