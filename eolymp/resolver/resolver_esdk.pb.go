...
type _ResolverHttpClient interface {
	Do(*http.Request) (*http.Response, error)
}

type ResolverService struct {
	base string
	cli  _ResolverHttpClient
}
...
func NewResolverHttpClient(url string, cli _ResolverHttpClient) *ResolverService {
	...
	return &ResolverService{base: url, cli: cli}
}

func (s *ResolverService) do(ctx context.Context, verb, path string, in, out proto.Message) (err error) {
	var body io.Reader
...
func (s *ResolverService) ResolveName(ctx context.Context, in *ResolveNameInput) (*ResolveNameOutput, error) {
	out := &ResolveNameOutput{}
	path := "/names/" + url.PathEscape(in.GetName())
