...
const (
	...
	Post_PUBLISHED      Post_Status = 2 // published and available to everyone
)
...
const (
	...
	Post_IN_REVIEW          Post_Moderation = 2 // not reviewed by moderator
...
func (Post_Extra) Descriptor() protoreflect.EnumDescriptor {
	return file_eolymp_discussion_post_proto_enumTypes[2].Descriptor()
}

func (Post_Extra) Type() protoreflect.EnumType {
	return &file_eolymp_discussion_post_proto_enumTypes[2]
}
...
type Post struct {
	...
	Moderation Post_Moderation `protobuf:"varint,5,opt,name=moderation,proto3,enum=eolymp.discussion.Post_Moderation" json:"moderation,omitempty"`
	...
	Title       string                 `protobuf:"bytes,100,opt,name=title,proto3" json:"title,omitempty"`     // title is populated automatically from first header in the message
	Image       *Post_Image            `protobuf:"bytes,103,opt,name=image,proto3" json:"image,omitempty"`     // image is populated automatically from first image in the message
	Preview     *ecm.Node              `protobuf:"bytes,104,opt,name=preview,proto3" json:"preview,omitempty"` // preview is populated automatically from first paragraph in the image
...
func (x *Post) GetImage() *Post_Image {
	if x != nil {
		return x.Image
	}
	return nil
...
func (x *Post) GetPreview() *ecm.Node {
	if x != nil {
		return x.Preview
	}
	return nil
...
var file_eolymp_discussion_post_proto_rawDesc = []byte{
	...
	0x22, 0xde, 0x08, 0x0a, 0x04, 0x50, 0x6f, 0x73, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18,
	...
	0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1e, 0x2e, 0x65, 0x6f,
	...
	0x74, 0x75, 0x73, 0x12, 0x42, 0x0a, 0x0a, 0x6d, 0x6f, 0x64, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x22, 0x2e, 0x65, 0x6f, 0x6c, 0x79, 0x6d, 0x70,
	...
	0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x17, 0x0a, 0x07, 0x74, 0x79, 0x70, 0x65, 0x5f,
	0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x74, 0x79, 0x70, 0x65, 0x49, 0x64,
	0x12, 0x19, 0x0a, 0x07, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x0a, 0x20, 0x01, 0x28,
	0x09, 0x48, 0x00, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x12, 0x1d, 0x0a, 0x09, 0x6d,
	0x65, 0x6d, 0x62, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00,
	...
	,
	...
	0x74, 0x12, 0x14, 0x0a, 0x05, 0x63, 0x6c, 0x61, 0x73, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x09,
	0x52, 0x05, 0x63, 0x6c, 0x61, 0x73, 0x73, 0x22, 0x36, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75,
	...
	0x12, 0x0d, 0x0a, 0x09, 0x50, 0x55, 0x42, 0x4c, 0x49, 0x53, 0x48, 0x45, 0x44, 0x10, 0x02, 0x22,
	0x5c, 0x0a, 0x0a, 0x4d, 0x6f, 0x64, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x16, 0x0a,
	0x12, 0x55, 0x4e, 0x4b, 0x4e, 0x4f, 0x57, 0x4e, 0x5f, 0x4d, 0x4f, 0x44, 0x45, 0x52, 0x41, 0x54,
	0x49, 0x4f, 0x4e, 0x10, 0x00, 0x12, 0x0b, 0x0a, 0x07, 0x50, 0x45, 0x4e, 0x44, 0x49, 0x4e, 0x47,
	...
	0x0c, 0x0a, 0x08, 0x52, 0x45, 0x4a, 0x45, 0x43, 0x54, 0x45, 0x44, 0x10, 0x04, 0x22, 0x58, 0x0a,
	0x05, 0x45, 0x78, 0x74, 0x72, 0x61, 0x12, 0x11, 0x0a, 0x0d, 0x55, 0x4e, 0x4b, 0x4e, 0x4f, 0x57,
	0x4e, 0x5f, 0x45, 0x58, 0x54, 0x52, 0x41, 0x10, 0x00, 0x12, 0x11, 0x0a, 0x0d, 0x4d, 0x45, 0x53,
	0x53, 0x41, 0x47, 0x45, 0x5f, 0x56, 0x41, 0x4c, 0x55, 0x45, 0x10, 0x01, 0x12, 0x12, 0x0a, 0x0e,
	0x4d, 0x45, 0x53, 0x53, 0x41, 0x47, 0x45, 0x5f, 0x52, 0x45, 0x4e, 0x44, 0x45, 0x52, 0x10, 0x02,
	0x12, 0x0b, 0x0a, 0x07, 0x50, 0x52, 0x45, 0x56, 0x49, 0x45, 0x57, 0x10, 0x03, 0x12, 0x08, 0x0a,
	0x04, 0x56, 0x4f, 0x54, 0x45, 0x10, 0x04, 0x42, 0x08, 0x0a, 0x06, 0x61, 0x75, 0x74, 0x68, 0x6f,
...
var file_eolymp_discussion_post_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_eolymp_discussion_post_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_eolymp_discussion_post_proto_goTypes = []interface{}{
	(Post_Status)(0),              // 0: eolymp.discussion.Post.Status
	(Post_Moderation)(0),          // 1: eolymp.discussion.Post.Moderation
	(Post_Extra)(0),               // 2: eolymp.discussion.Post.Extra
	(*Post)(nil),                  // 3: eolymp.discussion.Post
...
var file_eolymp_discussion_post_proto_depIdxs = []int32{
	...
	1, // 1: eolymp.discussion.Post.moderation:type_name -> eolymp.discussion.Post.Moderation
	5, // 2: eolymp.discussion.Post.created_at:type_name -> google.protobuf.Timestamp
	5, // 3: eolymp.discussion.Post.published_at:type_name -> google.protobuf.Timestamp
	5, // 4: eolymp.discussion.Post.updated_at:type_name -> google.protobuf.Timestamp
	4, // 5: eolymp.discussion.Post.image:type_name -> eolymp.discussion.Post.Image
	6, // 6: eolymp.discussion.Post.preview:type_name -> eolymp.ecm.Node
	7, // 7: eolymp.discussion.Post.message:type_name -> eolymp.ecm.Content
	8, // 8: eolymp.discussion.Post.links:type_name -> eolymp.wellknown.Link
