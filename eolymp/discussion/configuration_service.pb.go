...
var file_eolymp_discussion_configuration_service_proto_goTypes = []interface{}{
...
func file_eolymp_discussion_configuration_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_eolymp_discussion_configuration_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DescribeDiscussionConfigInput); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_eolymp_discussion_configuration_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DescribeDiscussionConfigOutput); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_eolymp_discussion_configuration_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateDiscussionConfigInput); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_eolymp_discussion_configuration_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateDiscussionConfigOutput); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
