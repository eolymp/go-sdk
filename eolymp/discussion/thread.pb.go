...
var file_eolymp_discussion_thread_proto_rawDesc = []byte{
	,
	...
	0x70, 0x6c, 0x79, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x42, 0x37, 0x5a, 0x35, 0x67, 0x69, 0x74, 0x68,
...
var (
	...
	file_eolymp_discussion_thread_proto_rawDescData = file_eolymp_discussion_thread_proto_rawDesc
)

func file_eolymp_discussion_thread_proto_rawDescGZIP() []byte {
	file_eolymp_discussion_thread_proto_rawDescOnce.Do(func() {
		file_eolymp_discussion_thread_proto_rawDescData = protoimpl.X.CompressGZIP(file_eolymp_discussion_thread_proto_rawDescData)
	})
...
var file_eolymp_discussion_thread_proto_goTypes = []interface{}{
...
func file_eolymp_discussion_thread_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_eolymp_discussion_thread_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Thread); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_eolymp_discussion_thread_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_eolymp_discussion_thread_proto_rawDesc = nil
