...
var file_eolymp_newsletter_recipient_proto_goTypes = []interface{}{
...
func file_eolymp_newsletter_recipient_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_eolymp_newsletter_recipient_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
