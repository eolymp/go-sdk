...
// _NewsletterService_WebsocketErrorResponse writes error to websocket connection
func _NewsletterService_WebsocketErrorResponse(conn *websocket.Conn, e error) {
...
// _NewsletterService_WebsocketCodec implements protobuf codec for websockets package
var _NewsletterService_WebsocketCodec = websocket.Codec{
