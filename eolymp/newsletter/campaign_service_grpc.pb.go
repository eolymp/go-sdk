...
func (UnimplementedCampaignServiceServer) DescribeCampaign(context.Context, *DescribeCampaignInput) (*DescribeCampaignOutput, error) {
	return nil, status.Error(codes.Unimplemented, "method DescribeCampaign not implemented")
}
...
func (UnimplementedCampaignServiceServer) SendCampaign(context.Context, *SendCampaignInput) (*SendCampaignOutput, error) {
	return nil, status.Error(codes.Unimplemented, "method SendCampaign not implemented")
}
func (UnimplementedCampaignServiceServer) TranslateCampaign(context.Context, *TranslateCampaignInput) (*TranslateCampaignOutput, error) {
	return nil, status.Error(codes.Unimplemented, "method TranslateCampaign not implemented")
}
