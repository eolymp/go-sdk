...
var file_eolymp_newsletter_newsletter_proto_goTypes = []interface{}{
...
func file_eolymp_newsletter_newsletter_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_eolymp_newsletter_newsletter_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_eolymp_newsletter_newsletter_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Newsletter_Translation); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
