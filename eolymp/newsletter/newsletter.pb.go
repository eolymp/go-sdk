...
func file_eolymp_newsletter_newsletter_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_eolymp_newsletter_newsletter_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_eolymp_newsletter_newsletter_proto_msgTypes[1].Exporter = func(v any, i int) any {
