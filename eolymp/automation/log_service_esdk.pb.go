...
type _LogServiceHttpClient interface {
	Do(*http.Request) (*http.Response, error)
}

type LogServiceService struct {
	base string
	cli  _LogServiceHttpClient
}

// NewLogServiceHttpClient constructs client for LogService
func NewLogServiceHttpClient(url string, cli _LogServiceHttpClient) *LogServiceService {
	if url == "" {
	...
	return &LogServiceService{base: url, cli: cli}
}

func (s *LogServiceService) do(ctx context.Context, verb, path string, in, out proto.Message) (err error) {
	var body io.Reader
...
func (s *LogServiceService) ListLogs(ctx context.Context, in *ListLogsInput) (*ListLogsOutput, error) {
	out := &ListLogsOutput{}
...
func (s *LogServiceService) DescribeLog(ctx context.Context, in *DescribeLogInput) (*DescribeLogOutput, error) {
	...
	path := "/automation/logs/" + url.PathEscape(in.GetLogId())
