...
type _ExecutorService_ExecuteJob_WSStream struct {
	ctx  context.Context
	conn *websocket.Conn
}

func (s *_ExecutorService_ExecuteJob_WSStream) Send(m *ExecuteJobUpdate) error {
	return s.SendMsg(m)
}

func (s *_ExecutorService_ExecuteJob_WSStream) SetHeader(metadata.MD) error {
	return nil
}

func (s *_ExecutorService_ExecuteJob_WSStream) SendHeader(metadata.MD) error {
	return nil
}

func (s *_ExecutorService_ExecuteJob_WSStream) SetTrailer(metadata.MD) {
}

func (s *_ExecutorService_ExecuteJob_WSStream) Context() context.Context {
	return s.ctx
}

func (s *_ExecutorService_ExecuteJob_WSStream) SendMsg(m interface{}) error {
	return _ExecutorService_WebsocketCodec.Send(s.conn, m)
}

func (s *_ExecutorService_ExecuteJob_WSStream) RecvMsg(m interface{}) error {
	return nil
}
...
func (i *ExecutorServiceInterceptor) ExecuteJob(ctx context.Context, in *ExecuteJobInput, opts ...grpc.CallOption) (ExecutorService_ExecuteJobClient, error) {
	return i.client.ExecuteJob(ctx, in, opts...)
}
