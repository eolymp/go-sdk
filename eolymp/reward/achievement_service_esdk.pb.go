...
func (s *AchievementServiceService) CreateAchievement(ctx context.Context, in *CreateAchievementInput) (*CreateAchievementOutput, error) {
	out := &CreateAchievementOutput{}
	path := "/achievements"
...
func (s *AchievementServiceService) UpdateAchievement(ctx context.Context, in *UpdateAchievementInput) (*UpdateAchievementOutput, error) {
	out := &UpdateAchievementOutput{}
...
func (s *AchievementServiceService) DescribeAchievement(ctx context.Context, in *DescribeAchievementInput) (*DescribeAchievementOutput, error) {
	out := &DescribeAchievementOutput{}
	path := "/achievements/" + url.PathEscape(in.GetAchievementId())
