...
func (c *logServiceClient) ExportLogs(ctx context.Context, in *ExportLogsInput, opts ...grpc.CallOption) (*ExportLogsOutput, error) {
	...
	err := c.cc.Invoke(ctx, LogService_ExportLogs_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _LogService_ExportLogs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LogService_ExportLogs_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LogServiceServer).ExportLogs(ctx, req.(*ExportLogsInput))
	}
	return interceptor(ctx, in, info, handler)
}
...
var LogService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "eolymp.audit.LogService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _LogService_ExportLogs_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "eolymp/audit/log_service.proto",
}
