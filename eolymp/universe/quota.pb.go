...
func (x *Quota) GetAutomationRulesPerSpace() uint32 {
	if x != nil {
		return x.AutomationRulesPerSpace
	}
	return 0
}

func (x *Quota) GetAutomationExecutionsPerMonth() uint32 {
	if x != nil {
		return x.AutomationExecutionsPerMonth
	}
	return 0
}
