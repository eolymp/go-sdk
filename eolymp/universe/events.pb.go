...
var file_eolymp_universe_events_proto_goTypes = []interface{}{
...
func file_eolymp_universe_events_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_eolymp_universe_events_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SpaceChangeRecord); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
