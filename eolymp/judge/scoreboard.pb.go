...
const (
	Scoreboard_NONE Scoreboard_Type = 0
	Scoreboard_IOI  Scoreboard_Type = 1
	Scoreboard_ICPC Scoreboard_Type = 2
)
...
type Scoreboard struct {
	...
	Type           Scoreboard_Type      `protobuf:"varint,10,opt,name=type,proto3,enum=eolymp.judge.Scoreboard_Type" json:"type,omitempty"`
	...
	FreezeIn       *duration.Duration   `protobuf:"bytes,22,opt,name=freeze_in,json=freezeIn,proto3" json:"freeze_in,omitempty"`
}
...
func (x *Scoreboard) GetType() Scoreboard_Type {
	if x != nil {
		return x.Type
	}
...
func (x *Scoreboard) GetFreezeIn() *duration.Duration {
	if x != nil {
		return x.FreezeIn
	}
	return nil
...
type Scoreboard_Row struct {
	...
	Breakdown     []*Scoreboard_Score `protobuf:"bytes,12,rep,name=breakdown,proto3" json:"breakdown,omitempty"` // breakdown of score by problem
}
...
type Scoreboard_Score struct {
	...
	Submits    uint32               `protobuf:"varint,6,opt,name=submits,proto3" json:"submits,omitempty"`                   // number of submits made so far
...
func (x *Scoreboard_Score) GetSubmits() uint32 {
	if x != nil {
		return x.Submits
	}
	return 0
...
var file_eolymp_judge_scoreboard_proto_rawDesc = []byte{
	...
	0x64, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb1,
	0x07, 0x0a, 0x0a, 0x53, 0x63, 0x6f, 0x72, 0x65, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x12, 0x0e, 0x0a,
	...
	,
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x62, 0x6f, 0x61, 0x72,
	0x64, 0x49, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x18, 0x0a, 0x20, 0x01,
	...
	,
	...
	0x43, 0x10, 0x02, 0x22, 0x3d, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x0b, 0x0a,
	...
	0x10, 0x02, 0x12, 0x0e, 0x0a, 0x0a, 0x52, 0x45, 0x42, 0x55, 0x49, 0x4c, 0x44, 0x49, 0x4e, 0x47,
...
var file_eolymp_judge_scoreboard_proto_goTypes = []interface{}{
	(Scoreboard_Type)(0),        // 0: eolymp.judge.Scoreboard.Type
	(Scoreboard_Status)(0),      // 1: eolymp.judge.Scoreboard.Status
	(*Scoreboard)(nil),          // 2: eolymp.judge.Scoreboard
	(*Scoreboard_Row)(nil),      // 3: eolymp.judge.Scoreboard.Row
	(*Scoreboard_Score)(nil),    // 4: eolymp.judge.Scoreboard.Score
	(*timestamp.Timestamp)(nil), // 5: google.protobuf.Timestamp
	(*duration.Duration)(nil),   // 6: google.protobuf.Duration
}
var file_eolymp_judge_scoreboard_proto_depIdxs = []int32{
	0, // 0: eolymp.judge.Scoreboard.type:type_name -> eolymp.judge.Scoreboard.Type
	1, // 1: eolymp.judge.Scoreboard.status:type_name -> eolymp.judge.Scoreboard.Status
	5, // 2: eolymp.judge.Scoreboard.freeze_time:type_name -> google.protobuf.Timestamp
	6, // 3: eolymp.judge.Scoreboard.freeze_in:type_name -> google.protobuf.Duration
	4, // 4: eolymp.judge.Scoreboard.Row.breakdown:type_name -> eolymp.judge.Scoreboard.Score
	5, // 5: eolymp.judge.Scoreboard.Score.solved_at:type_name -> google.protobuf.Timestamp
