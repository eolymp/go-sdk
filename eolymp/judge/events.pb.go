...
var file_eolymp_judge_events_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x6e, 0x22, 0x42, 0x0a, 0x12, 0x54, 0x69, 0x63, 0x6b, 0x65, 0x74, 0x43, 0x72, 0x65,
...
var file_eolymp_judge_events_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_eolymp_judge_events_proto_goTypes = []interface{}{
	(*SubmissionCompletedEvent)(nil), // 0: eolymp.judge.SubmissionCompletedEvent
	(*TicketCreatedEvent)(nil),       // 1: eolymp.judge.TicketCreatedEvent
	(*TicketUpdatedEvent)(nil),       // 2: eolymp.judge.TicketUpdatedEvent
	(*Submission)(nil),               // 3: eolymp.judge.Submission
	(*Ticket)(nil),                   // 4: eolymp.judge.Ticket
	(*Reply)(nil),                    // 5: eolymp.judge.Reply
}
var file_eolymp_judge_events_proto_depIdxs = []int32{
	3, // 0: eolymp.judge.SubmissionCompletedEvent.submission:type_name -> eolymp.judge.Submission
	4, // 1: eolymp.judge.TicketCreatedEvent.ticket:type_name -> eolymp.judge.Ticket
	4, // 2: eolymp.judge.TicketUpdatedEvent.ticket:type_name -> eolymp.judge.Ticket
	5, // 3: eolymp.judge.TicketUpdatedEvent.reply:type_name -> eolymp.judge.Reply
