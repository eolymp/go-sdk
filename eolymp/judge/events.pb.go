...
var file_eolymp_judge_events_proto_rawDesc = []byte{
	...
	0x79, 0x6d, 0x70, 0x2e, 0x6a, 0x75, 0x64, 0x67, 0x65, 0x1a, 0x1d, 0x65, 0x6f, 0x6c, 0x79, 0x6d,
	...
	0x65, 0x2f, 0x72, 0x65, 0x70, 0x6c, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x54, 0x0a,
	0x18, 0x53, 0x75, 0x62, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x6d, 0x70, 0x6c,
	0x65, 0x74, 0x65, 0x64, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x38, 0x0a, 0x0a, 0x73, 0x75, 0x62,
	...
	0x69, 0x6f, 0x6e, 0x22, 0x5e, 0x0a, 0x16, 0x52, 0x65, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x53, 0x63,
	0x6f, 0x72, 0x65, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x23, 0x0a,
	...
	0x79, 0x49, 0x64, 0x22, 0x42, 0x0a, 0x12, 0x54, 0x69, 0x63, 0x6b, 0x65, 0x74, 0x43, 0x72, 0x65,
	...
	0x06, 0x74, 0x69, 0x63, 0x6b, 0x65, 0x74, 0x22, 0x6d, 0x0a, 0x12, 0x54, 0x69, 0x63, 0x6b, 0x65,
	...
	0x6b, 0x65, 0x74, 0x52, 0x06, 0x74, 0x69, 0x63, 0x6b, 0x65, 0x74, 0x12, 0x29, 0x0a, 0x05, 0x72,
	...
	0x05, 0x72, 0x65, 0x70, 0x6c, 0x79, 0x42, 0x33, 0x5a, 0x31, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_eolymp_judge_events_proto_goTypes = []interface{}{
	...
	(*TicketCreatedEvent)(nil),       // 2: eolymp.judge.TicketCreatedEvent
	(*TicketUpdatedEvent)(nil),       // 3: eolymp.judge.TicketUpdatedEvent
	(*Submission)(nil),               // 4: eolymp.judge.Submission
	(*Ticket)(nil),                   // 5: eolymp.judge.Ticket
	(*Reply)(nil),                    // 6: eolymp.judge.Reply
}
var file_eolymp_judge_events_proto_depIdxs = []int32{
	...
	5, // 1: eolymp.judge.TicketCreatedEvent.ticket:type_name -> eolymp.judge.Ticket
	5, // 2: eolymp.judge.TicketUpdatedEvent.ticket:type_name -> eolymp.judge.Ticket
	6, // 3: eolymp.judge.TicketUpdatedEvent.reply:type_name -> eolymp.judge.Reply
