...
func (s *EditorServiceService) DescribeEditor(ctx context.Context, in *DescribeEditorInput) (*DescribeEditorOutput, error) {
	...
	path := "/contests/" + url.PathEscape(in.GetContestId()) + "/problems/" + url.PathEscape(in.GetProblemId()) + "/editor"
...
func (s *EditorServiceService) DescribeEditorState(ctx context.Context, in *DescribeEditorStateInput) (*DescribeEditorStateOutput, error) {
	...
	path := "/contests/" + url.PathEscape(in.GetContestId()) + "/problems/" + url.PathEscape(in.GetProblemId()) + "/editor/state"
...
func (s *EditorServiceService) ListInputs(ctx context.Context, in *ListInputsInput) (*ListInputsOutput, error) {
	...
	path := "/contests/" + url.PathEscape(in.GetContestId()) + "/problems/" + url.PathEscape(in.GetProblemId()) + "/inputs"
...
func (s *EditorServiceService) PrintEditorCode(ctx context.Context, in *PrintEditorCodeInput) (*PrintEditorCodeOutput, error) {
	...
	path := "/contests/" + url.PathEscape(in.GetContestId()) + "/problems/" + url.PathEscape(in.GetProblemId()) + "/editor/print"
