...
const (
	...
	Participant_UNREGISTERED Participant_Status = 5 // participant needs to fill registration form
)
...
type Participant struct {
	...
	Breakdown []*Participant_Score `protobuf:"bytes,12,rep,name=breakdown,proto3" json:"breakdown,omitempty"`                 // breakdown of score by problem
...
func (x *Participant) GetScore() float32 {
	if x != nil {
		return x.Score
	}
	return 0
...
func (x *Participant) GetPenalty() float32 {
	if x != nil {
		return x.Penalty
	}
	return 0
...
func (x *Participant) GetBreakdown() []*Participant_Score {
	if x != nil {
		return x.Breakdown
	}
	return nil
...
func (x *Participant_Score) Reset() {
	*x = Participant_Score{}
	if protoimpl.UnsafeEnabled {
...
func (x *Participant_Score) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Participant_Score) ProtoMessage() {}

func (x *Participant_Score) ProtoReflect() protoreflect.Message {
	mi := &file_eolymp_judge_participant_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Participant_Score.ProtoReflect.Descriptor instead.
func (*Participant_Score) Descriptor() ([]byte, []int) {
	return file_eolymp_judge_participant_proto_rawDescGZIP(), []int{0, 0}
}

func (x *Participant_Score) GetProblemId() string {
	if x != nil {
		return x.ProblemId
	}
	return ""
...
func (x *Participant_Score) GetScore() float32 {
	if x != nil {
		return x.Score
	}
	return 0
...
func (x *Participant_Score) GetPenalty() float32 {
	if x != nil {
		return x.Penalty
	}
	return 0
...
func (x *Participant_Score) GetSolved() bool {
	if x != nil {
		return x.Solved
	}
	return false
...
func (x *Participant_Score) GetPercentage() float32 {
	if x != nil {
		return x.Percentage
	}
	return 0
...
func (x *Participant_Score) GetSubmits() uint32 {
	if x != nil {
		return x.Submits
	}
	return 0
...
var file_eolymp_judge_participant_proto_rawDesc = []byte{
	...
	,
	...
	0x6c, 0x74, 0x79, 0x12, 0x3d, 0x0a, 0x09, 0x62, 0x72, 0x65, 0x61, 0x6b, 0x64, 0x6f, 0x77, 0x6e,
	0x18, 0x0c, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x65, 0x6f, 0x6c, 0x79, 0x6d, 0x70, 0x2e,
	0x6a, 0x75, 0x64, 0x67, 0x65, 0x2e, 0x50, 0x61, 0x72, 0x74, 0x69, 0x63, 0x69, 0x70, 0x61, 0x6e,
	0x74, 0x2e, 0x53, 0x63, 0x6f, 0x72, 0x65, 0x52, 0x09, 0x62, 0x72, 0x65, 0x61, 0x6b, 0x64, 0x6f,
	0x77, 0x6e, 0x12, 0x38, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x14, 0x20, 0x01,
	0x28, 0x0e, 0x32, 0x20, 0x2e, 0x65, 0x6f, 0x6c, 0x79, 0x6d, 0x70, 0x2e, 0x6a, 0x75, 0x64, 0x67,
	0x65, 0x2e, 0x50, 0x61, 0x72, 0x74, 0x69, 0x63, 0x69, 0x70, 0x61, 0x6e, 0x74, 0x2e, 0x53, 0x74,
	...
	0x61, 0x72, 0x74, 0x65, 0x64, 0x41, 0x74, 0x12, 0x38, 0x0a, 0x0a, 0x73, 0x74, 0x61, 0x72, 0x74,
	0x65, 0x64, 0x5f, 0x69, 0x6e, 0x18, 0x16, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x67, 0x6f,
	0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x44, 0x75,
	0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x09, 0x73, 0x74, 0x61, 0x72, 0x74, 0x65, 0x64, 0x49,
	...
	0x6d, 0x70, 0x52, 0x0a, 0x63, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74, 0x65, 0x41, 0x74, 0x12, 0x3a,
	...
	0x63, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74, 0x65, 0x49, 0x6e, 0x12, 0x1a, 0x0a, 0x08, 0x70, 0x61,
	0x73, 0x73, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x1e, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x70, 0x61,
	0x73, 0x73, 0x63, 0x6f, 0x64, 0x65, 0x1a, 0xa8, 0x01, 0x0a, 0x05, 0x53, 0x63, 0x6f, 0x72, 0x65,
	...
	,
...
var file_eolymp_judge_participant_proto_goTypes = []interface{}{
	...
	(*Participant_Score)(nil),   // 2: eolymp.judge.Participant.Score
	(*timestamp.Timestamp)(nil), // 3: google.protobuf.Timestamp
	(*duration.Duration)(nil),   // 4: google.protobuf.Duration
}
var file_eolymp_judge_participant_proto_depIdxs = []int32{
	2, // 0: eolymp.judge.Participant.breakdown:type_name -> eolymp.judge.Participant.Score
...
func file_eolymp_judge_participant_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_eolymp_judge_participant_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Participant_Score); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
