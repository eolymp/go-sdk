...
var file_eolymp_judge_ticket_reply_proto_rawDesc = []byte{
...
var (
	...
	file_eolymp_judge_ticket_reply_proto_rawDescData = file_eolymp_judge_ticket_reply_proto_rawDesc
)

func file_eolymp_judge_ticket_reply_proto_rawDescGZIP() []byte {
	file_eolymp_judge_ticket_reply_proto_rawDescOnce.Do(func() {
		file_eolymp_judge_ticket_reply_proto_rawDescData = protoimpl.X.CompressGZIP(file_eolymp_judge_ticket_reply_proto_rawDescData)
	})
...
var file_eolymp_judge_ticket_reply_proto_goTypes = []interface{}{
...
func file_eolymp_judge_ticket_reply_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_eolymp_judge_ticket_reply_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Reply); i {
			case 0:
				return &v.state
			case 1:
	...
	file_eolymp_judge_ticket_reply_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*Reply_UserId)(nil),
		(*Reply_MemberId)(nil),
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_eolymp_judge_ticket_reply_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_eolymp_judge_ticket_reply_proto_rawDesc = nil
