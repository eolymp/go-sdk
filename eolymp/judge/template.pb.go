...
type Template struct {
	...
	HeaderUrl string           `protobuf:"bytes,11,opt,name=header_url,json=headerUrl,proto3" json:"header_url,omitempty"`
	FooterUrl string           `protobuf:"bytes,12,opt,name=footer_url,json=footerUrl,proto3" json:"footer_url,omitempty"`
...
func (x *Template) GetSourceUrl() string {
	if x != nil {
		return x.SourceUrl
	}
	return ""
...
func (x *Template) GetHeaderUrl() string {
	if x != nil {
		return x.HeaderUrl
	}
	return ""
...
func (x *Template) GetFooterUrl() string {
	if x != nil {
		return x.FooterUrl
	}
	return ""
...
var file_eolymp_judge_template_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xdd, 0x01, 0x0a, 0x08, 0x54, 0x65, 0x6d, 0x70,
	...
	0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x5f, 0x75, 0x72, 0x6c, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x09, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x55, 0x72, 0x6c, 0x12, 0x1d, 0x0a, 0x0a, 0x66,
	0x6f, 0x6f, 0x74, 0x65, 0x72, 0x5f, 0x75, 0x72, 0x6c, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x09, 0x66, 0x6f, 0x6f, 0x74, 0x65, 0x72, 0x55, 0x72, 0x6c, 0x12, 0x2b, 0x0a, 0x05, 0x66, 0x69,
	0x6c, 0x65, 0x73, 0x18, 0x1e, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x65, 0x6f, 0x6c, 0x79,
