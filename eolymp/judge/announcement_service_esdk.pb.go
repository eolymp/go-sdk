...
type _AnnouncementServiceHttpClient interface {
	Do(*http.Request) (*http.Response, error)
}

type AnnouncementServiceService struct {
	base string
	cli  _AnnouncementServiceHttpClient
}

// NewAnnouncementServiceHttpClient constructs client for AnnouncementService
func NewAnnouncementServiceHttpClient(url string, cli _AnnouncementServiceHttpClient) *AnnouncementServiceService {
	if url == "" {
	...
	return &AnnouncementServiceService{base: url, cli: cli}
}

func (s *AnnouncementServiceService) do(ctx context.Context, verb, path string, in, out proto.Message) (err error) {
	var body io.Reader
