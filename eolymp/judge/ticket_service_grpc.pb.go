...
func (c *ticketServiceClient) WatchTicket(ctx context.Context, in *WatchTicketInput, opts ...grpc.CallOption) (TicketService_WatchTicketClient, error) {
	...
	x := &ticketServiceWatchTicketClient{ClientStream: stream}
...
func (c *ticketServiceClient) WatchTickets(ctx context.Context, in *WatchTicketsInput, opts ...grpc.CallOption) (TicketService_WatchTicketsClient, error) {
	...
	x := &ticketServiceWatchTicketsClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func (c *ticketServiceClient) WatchTicketSummary(ctx context.Context, in *WatchTicketSummaryInput, opts ...grpc.CallOption) (TicketService_WatchTicketSummaryClient, error) {
	...
	x := &ticketServiceWatchTicketSummaryClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func (c *ticketServiceClient) WatchReplies(ctx context.Context, in *WatchRepliesInput, opts ...grpc.CallOption) (TicketService_WatchRepliesClient, error) {
	...
	x := &ticketServiceWatchRepliesClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func _TicketService_WatchTicket_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(TicketServiceServer).WatchTicket(m, &ticketServiceWatchTicketServer{ServerStream: stream})
}
...
func _TicketService_WatchTickets_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(TicketServiceServer).WatchTickets(m, &ticketServiceWatchTicketsServer{ServerStream: stream})
}
...
func _TicketService_WatchTicketSummary_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(TicketServiceServer).WatchTicketSummary(m, &ticketServiceWatchTicketSummaryServer{ServerStream: stream})
}
...
func _TicketService_WatchReplies_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(TicketServiceServer).WatchReplies(m, &ticketServiceWatchRepliesServer{ServerStream: stream})
}
