...
type Submission struct {
	...
	GenaiUseProbability float32                  `protobuf:"fixed32,48,opt,name=genai_use_probability,json=genaiUseProbability,proto3" json:"genai_use_probability,omitempty"` // Probability that the submission code was generated by an AI (0 to 1)
...
func (x *Submission) GetGenaiUseProbability() float32 {
	if x != nil {
		return x.GenaiUseProbability
	}
	return 0
}
...
const file_eolymp_judge_submission_proto_rawDesc = "" +
	"\n" +
	"\x1deolymp/judge/submission.proto\x12\feolymp.judge\x1a\x1deolymp/atlas/submission.proto\x1a#eolymp/atlas/testing_feedback.proto\x1a\"eolymp/atlas/testing_scoring.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x8b\x0e\n" +
	"\n" +
	"Submission\x12\x0e\n" +
	...
	"\x0eresource_usage\x18/ \x01(\x02R\rresourceUsage\x122\n" +
	"\x15genai_use_probability\x180 \x01(\x02R\x13genaiUseProbability\x126\n" +
