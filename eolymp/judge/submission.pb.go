...
const (
	...
	Submission_Run_TIMEOUT            Submission_Run_Status = 3  // time limit exceeded
	Submission_Run_OVERFLOW           Submission_Run_Status = 4  // memory limit exceeded
	Submission_Run_WRONG_ANSWER       Submission_Run_Status = 5  // wrong answer
	Submission_Run_ACCEPTED           Submission_Run_Status = 6  // answer accepted
	Submission_Run_RUNTIME_ERROR      Submission_Run_Status = 7  // program returned non 0 exit code
	Submission_Run_VERIFICATION_ERROR Submission_Run_Status = 8  // verifier couldn't run
	Submission_Run_SKIPPED            Submission_Run_Status = 9  // run won't be executed
	Submission_Run_BLOCKED            Submission_Run_Status = 10 // dependant test did not pass
)
...
const (
	...
	Submission_Group_OVERFLOW           Submission_Group_Status = 6  // first not accepted run has status Memory limit exceeded
	Submission_Group_WRONG_ANSWER       Submission_Group_Status = 7  // first not accepted run has status Wrong Answer
	Submission_Group_RUNTIME_ERROR      Submission_Group_Status = 8  // first not accepted run has status Runtime Error
	Submission_Group_VERIFICATION_ERROR Submission_Group_Status = 9  // first not accepted run has status Verification Error
	Submission_Group_SKIPPED            Submission_Group_Status = 10 // first not accepted run has status Skipped
)
...
func (Submission_Group_ScoringMode) EnumDescriptor() ([]byte, []int) {
	return file_eolymp_judge_submission_proto_rawDescGZIP(), []int{0, 1, 1}
}
...
func (Submission_Group_FeedbackPolicy) Descriptor() protoreflect.EnumDescriptor {
	return file_eolymp_judge_submission_proto_enumTypes[4].Descriptor()
}

func (Submission_Group_FeedbackPolicy) Type() protoreflect.EnumType {
	return &file_eolymp_judge_submission_proto_enumTypes[4]
}
...
func (Submission_Group_FeedbackPolicy) EnumDescriptor() ([]byte, []int) {
	return file_eolymp_judge_submission_proto_rawDescGZIP(), []int{0, 1, 2}
}
...
type Submission_Group struct {
	...
	ScoringMode    Submission_Group_ScoringMode    `protobuf:"varint,22,opt,name=scoring_mode,json=scoringMode,proto3,enum=eolymp.judge.Submission_Group_ScoringMode" json:"scoring_mode,omitempty"`             // how group is scored
	FeedbackPolicy Submission_Group_FeedbackPolicy `protobuf:"varint,30,opt,name=feedback_policy,json=feedbackPolicy,proto3,enum=eolymp.judge.Submission_Group_FeedbackPolicy" json:"feedback_policy,omitempty"` // how tests are shown to the user
	TimeUsage      uint32                          `protobuf:"varint,41,opt,name=time_usage,json=timeUsage,proto3" json:"time_usage,omitempty"`                                                                  // provides feedback on time usage within the group, depending on feedback mode it might be max execution time in group or time usage in the first non-accepted test
...
var file_eolymp_judge_submission_proto_rawDesc = []byte{
	...
	0x0d, 0x0a, 0x0a, 0x53, 0x75, 0x62, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x0e, 0x0a,
	...
	0x52, 0x09, 0x70, 0x72, 0x6f, 0x62, 0x6c, 0x65, 0x6d, 0x49, 0x64, 0x12, 0x25, 0x0a, 0x0e, 0x70,
	...
	0x74, 0x12, 0x12, 0x0a, 0x04, 0x6c, 0x61, 0x6e, 0x67, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x09, 0x52,
	...
	0x52, 0x09, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x12, 0x37, 0x0a, 0x06, 0x73,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x14, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1f, 0x2e, 0x65, 0x6f,
	...
	0x61, 0x74, 0x75, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x18, 0x15, 0x20,
	...
	0x72, 0x6f, 0x75, 0x70, 0x52, 0x06, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x73, 0x1a, 0x9e, 0x03, 0x0a,
	0x03, 0x52, 0x75, 0x6e, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x02, 0x69, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x74, 0x69, 0x6d, 0x65, 0x5f, 0x75, 0x73, 0x61,
	0x67, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x55, 0x73,
	...
	,
	...
	,
	...
	0x09, 0x52, 0x09, 0x74, 0x65, 0x73, 0x74, 0x73, 0x65, 0x74, 0x49, 0x64, 0x12, 0x3d, 0x0a, 0x06,
	0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x25, 0x2e, 0x65,
	0x6f, 0x6c, 0x79, 0x6d, 0x70, 0x2e, 0x6a, 0x75, 0x64, 0x67, 0x65, 0x2e, 0x53, 0x75, 0x62, 0x6d,
	0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x2e, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x2e, 0x53, 0x74, 0x61,
	...
	,
	...
	0x72, 0x75, 0x6e, 0x73, 0x22, 0xaf, 0x01, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12,
	...
	,
	...
	0x12, 0x0b, 0x0a, 0x07, 0x46, 0x41, 0x49, 0x4c, 0x55, 0x52, 0x45, 0x10, 0x06, 0x42, 0x33, 0x5a,
...
var file_eolymp_judge_submission_proto_enumTypes = make([]protoimpl.EnumInfo, 5)
...
var file_eolymp_judge_submission_proto_goTypes = []interface{}{
	...
	(Submission_Group_ScoringMode)(0),    // 3: eolymp.judge.Submission.Group.ScoringMode
	(Submission_Group_FeedbackPolicy)(0), // 4: eolymp.judge.Submission.Group.FeedbackPolicy
...
var file_eolymp_judge_submission_proto_depIdxs = []int32{
	...
	7, // 2: eolymp.judge.Submission.groups:type_name -> eolymp.judge.Submission.Group
	...
	3, // 5: eolymp.judge.Submission.Group.scoring_mode:type_name -> eolymp.judge.Submission.Group.ScoringMode
	4, // 6: eolymp.judge.Submission.Group.feedback_policy:type_name -> eolymp.judge.Submission.Group.FeedbackPolicy
	6, // 7: eolymp.judge.Submission.Group.runs:type_name -> eolymp.judge.Submission.Run
