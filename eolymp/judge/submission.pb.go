...
type Submission struct {
	...
	Values        []*atlas.Form_Value      `protobuf:"bytes,111,rep,name=values,proto3" json:"values,omitempty"`
...
func (x *Submission) GetValues() []*atlas.Form_Value {
	if x != nil {
		return x.Values
	}
	return nil
...
const file_eolymp_judge_submission_proto_rawDesc = "" +
	"\n" +
	"\x1deolymp/judge/submission.proto\x12\feolymp.judge\x1a\x17eolymp/atlas/form.proto\x1a\x1deolymp/atlas/submission.proto\x1a#eolymp/atlas/testing_feedback.proto\x1a\"eolymp/atlas/testing_scoring.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xb2\x0e\n" +
	"\n" +
	"Submission\x12\x0e\n" +
	...
	"\n" +
	"source_url\x18n \x01(\tR\tsourceUrl\x120\n" +
	"\x06values\x18o \x03(\v2\x18.eolymp.atlas.Form.ValueR\x06values\x12\x1c\n" +
...
var file_eolymp_judge_submission_proto_goTypes = []any{
	...
	(*atlas.Form_Value)(nil),      // 5: eolymp.atlas.Form.Value
...
var file_eolymp_judge_submission_proto_depIdxs = []int32{
	...
	5,  // 1: eolymp.judge.Submission.values:type_name -> eolymp.atlas.Form.Value
