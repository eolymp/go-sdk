...
type Submission struct {
	...
	Values        []*atlas.Submission_Value `protobuf:"bytes,111,rep,name=values,proto3" json:"values,omitempty"`
...
const file_eolymp_judge_submission_proto_rawDesc = "" +
	...
	"\x06values\x18o \x03(\v2\x1e.eolymp.atlas.Submission.ValueR\x06values\x12\x1c\n" +
