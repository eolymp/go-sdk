...
type _RegistrationServiceHttpClient interface {
	Do(*http.Request) (*http.Response, error)
}

type RegistrationServiceService struct {
	base string
	cli  _RegistrationServiceHttpClient
}

// NewRegistrationServiceHttpClient constructs client for RegistrationService
func NewRegistrationServiceHttpClient(url string, cli _RegistrationServiceHttpClient) *RegistrationServiceService {
	if url == "" {
	...
	return &RegistrationServiceService{base: url, cli: cli}
}

func (s *RegistrationServiceService) do(ctx context.Context, verb, path string, in, out proto.Message) (err error) {
	var body io.Reader
