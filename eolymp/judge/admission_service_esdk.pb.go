...
type _AdmissionServiceHttpClient interface {
	Do(*http.Request) (*http.Response, error)
}

type AdmissionServiceService struct {
	base string
	cli  _AdmissionServiceHttpClient
}

// NewAdmissionServiceHttpClient constructs client for AdmissionService
func NewAdmissionServiceHttpClient(url string, cli _AdmissionServiceHttpClient) *AdmissionServiceService {
	if url == "" {
	...
	return &AdmissionServiceService{base: url, cli: cli}
}

func (s *AdmissionServiceService) do(ctx context.Context, verb, path string, in, out proto.Message) (err error) {
	var body io.Reader
