...
func (x *CreateRunInput) Reset() {
	*x = CreateRunInput{}
	mi := &file_eolymp_judge_run_service_proto_msgTypes[0]
...
func (*CreateRunInput) Descriptor() ([]byte, []int) {
	return file_eolymp_judge_run_service_proto_rawDescGZIP(), []int{0}
}

func (x *CreateRunInput) GetContestId() string {
	if x != nil {
		return x.ContestId
	}
	return ""
...
func (x *CreateRunOutput) Reset() {
	*x = CreateRunOutput{}
	mi := &file_eolymp_judge_run_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateRunOutput) Descriptor() ([]byte, []int) {
	return file_eolymp_judge_run_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *DescribeRunInput) Reset() {
	*x = DescribeRunInput{}
	mi := &file_eolymp_judge_run_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DescribeRunInput) Descriptor() ([]byte, []int) {
	return file_eolymp_judge_run_service_proto_rawDescGZIP(), []int{2}
}

func (x *DescribeRunInput) GetContestId() string {
	if x != nil {
		return x.ContestId
	}
	return ""
...
func (x *DescribeRunOutput) Reset() {
	*x = DescribeRunOutput{}
	mi := &file_eolymp_judge_run_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DescribeRunOutput) Descriptor() ([]byte, []int) {
	return file_eolymp_judge_run_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *WatchRunInput) Reset() {
	*x = WatchRunInput{}
	mi := &file_eolymp_judge_run_service_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*WatchRunInput) Descriptor() ([]byte, []int) {
	return file_eolymp_judge_run_service_proto_rawDescGZIP(), []int{4}
}

func (x *WatchRunInput) GetContestId() string {
	if x != nil {
		return x.ContestId
	}
	return ""
...
type WatchRunOutput struct {
	...
	Run           *atlas.Run               `protobuf:"bytes,2,opt,name=run,proto3" json:"run,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *WatchRunOutput) Reset() {
	*x = WatchRunOutput{}
	mi := &file_eolymp_judge_run_service_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*WatchRunOutput) Descriptor() ([]byte, []int) {
	return file_eolymp_judge_run_service_proto_rawDescGZIP(), []int{5}
}
...
const file_eolymp_judge_run_service_proto_rawDesc = "" +
	...
	"\x05trace\x18\x04 \x01(\bR\x05trace\x12\x16\n" +
	...
	"\x06run_id\x18\x03 \x01(\tR\x05runId\"8\n" +
	...
	"\x03run\x18\x02 \x01(\v2\x11.eolymp.atlas.RunR\x03run2\xef\x04\n" +
	"\n" +
...
var (
	...
	file_eolymp_judge_run_service_proto_rawDescData []byte
)

func file_eolymp_judge_run_service_proto_rawDescGZIP() []byte {
	file_eolymp_judge_run_service_proto_rawDescOnce.Do(func() {
		file_eolymp_judge_run_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_eolymp_judge_run_service_proto_rawDesc), len(file_eolymp_judge_run_service_proto_rawDesc)))
	})
	return file_eolymp_judge_run_service_proto_rawDescData
}

var file_eolymp_judge_run_service_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_eolymp_judge_run_service_proto_goTypes = []any{
	(*CreateRunInput)(nil),        // 0: eolymp.judge.CreateRunInput
	(*CreateRunOutput)(nil),       // 1: eolymp.judge.CreateRunOutput
	(*DescribeRunInput)(nil),      // 2: eolymp.judge.DescribeRunInput
	(*DescribeRunOutput)(nil),     // 3: eolymp.judge.DescribeRunOutput
	(*WatchRunInput)(nil),         // 4: eolymp.judge.WatchRunInput
	(*WatchRunOutput)(nil),        // 5: eolymp.judge.WatchRunOutput
	(*atlas.Run)(nil),             // 6: eolymp.atlas.Run
	(wellknown.WatchEventType)(0), // 7: eolymp.wellknown.WatchEventType
}
var file_eolymp_judge_run_service_proto_depIdxs = []int32{
	6, // 0: eolymp.judge.DescribeRunOutput.run:type_name -> eolymp.atlas.Run
	7, // 1: eolymp.judge.WatchRunOutput.event:type_name -> eolymp.wellknown.WatchEventType
	6, // 2: eolymp.judge.WatchRunOutput.run:type_name -> eolymp.atlas.Run
	0, // 3: eolymp.judge.RunService.CreateRun:input_type -> eolymp.judge.CreateRunInput
	2, // 4: eolymp.judge.RunService.DescribeRun:input_type -> eolymp.judge.DescribeRunInput
	4, // 5: eolymp.judge.RunService.WatchRun:input_type -> eolymp.judge.WatchRunInput
	1, // 6: eolymp.judge.RunService.CreateRun:output_type -> eolymp.judge.CreateRunOutput
	3, // 7: eolymp.judge.RunService.DescribeRun:output_type -> eolymp.judge.DescribeRunOutput
	5, // 8: eolymp.judge.RunService.WatchRun:output_type -> eolymp.judge.WatchRunOutput
...
func init() { file_eolymp_judge_run_service_proto_init() }
func file_eolymp_judge_run_service_proto_init() {
	if File_eolymp_judge_run_service_proto != nil {
		return
	}
	file_eolymp_judge_run_service_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_eolymp_judge_run_service_proto_rawDesc), len(file_eolymp_judge_run_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_eolymp_judge_run_service_proto_goTypes,
		DependencyIndexes: file_eolymp_judge_run_service_proto_depIdxs,
		MessageInfos:      file_eolymp_judge_run_service_proto_msgTypes,
	}.Build()
	File_eolymp_judge_run_service_proto = out.File
	file_eolymp_judge_run_service_proto_goTypes = nil
	file_eolymp_judge_run_service_proto_depIdxs = nil
}
