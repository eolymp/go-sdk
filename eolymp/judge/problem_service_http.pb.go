...
func RegisterProblemServiceHttpHandlers(router *mux.Router, prefix string, cli ProblemServiceClient) {
	...
	router.Handle(prefix+"/contests/{contest_id}/problems/{problem_id}/questions", _ProblemService_ListQuestions_Rule0(cli)).
		Methods("GET").
		Name("eolymp.judge.ProblemService.ListQuestions")
	router.Handle(prefix+"/contests/{contest_id}/problems/{problem_id}/widget", _ProblemService_DescribeWidget_Rule0(cli)).
		Methods("GET").
		Name("eolymp.judge.ProblemService.DescribeWidget")
...
func _ProblemService_DeleteProblem_Rule0(cli ProblemServiceClient) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if err := _ProblemService_HTTPReadRequest(r, in, 1048576, 131072); err != nil {
			_ProblemService_HTTPWriteErrorResponse(w, err)
			return
		}
