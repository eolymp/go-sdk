...
func RegisterConfigurationServiceHttpHandlers(router *mux.Router, prefix string, cli ConfigurationServiceClient) {
	router.Handle(prefix+"/contests/{contest_id}/environment", _ConfigurationService_DescribeEnvironment_Rule0(cli)).
		Methods("POST").
		Name("eolymp.judge.ConfigurationService.DescribeEnvironment")
	router.Handle(prefix+"/contests/{contest_id}/environment", _ConfigurationService_ConfigureEnvironment_Rule0(cli)).
		Methods("POST").
		Name("eolymp.judge.ConfigurationService.ConfigureEnvironment")
	router.Handle(prefix+"/contests/{contest_id}/certification", _ConfigurationService_DescribeCertification_Rule0(cli)).
		Methods("POST").
		Name("eolymp.judge.ConfigurationService.DescribeCertification")
	router.Handle(prefix+"/contests/{contest_id}/certification", _ConfigurationService_ConfigureCertification_Rule0(cli)).
		Methods("POST").
		Name("eolymp.judge.ConfigurationService.ConfigureCertification")
	router.Handle(prefix+"/contests/{contest_id}/taxonomy", _ConfigurationService_DescribeTaxonomy_Rule0(cli)).
		Methods("POST").
		Name("eolymp.judge.ConfigurationService.DescribeTaxonomy")
	router.Handle(prefix+"/contests/{contest_id}/taxonomy", _ConfigurationService_ConfigureTaxonomy_Rule0(cli)).
		Methods("POST").
		Name("eolymp.judge.ConfigurationService.ConfigureTaxonomy")
}
...
func _ConfigurationService_DescribeEnvironment_Rule0(cli ConfigurationServiceClient) http.Handler {
...
func _ConfigurationService_ConfigureEnvironment_Rule0(cli ConfigurationServiceClient) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
...
func _ConfigurationService_DescribeCertification_Rule0(cli ConfigurationServiceClient) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
...
func _ConfigurationService_ConfigureCertification_Rule0(cli ConfigurationServiceClient) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
...
func _ConfigurationService_DescribeTaxonomy_Rule0(cli ConfigurationServiceClient) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
...
func _ConfigurationService_ConfigureTaxonomy_Rule0(cli ConfigurationServiceClient) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
