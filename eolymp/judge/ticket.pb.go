...
var file_eolymp_judge_ticket_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xe6, 0x03, 0x0a, 0x06, 0x54, 0x69, 0x63, 0x6b, 0x65, 0x74, 0x12,
...
var file_eolymp_judge_ticket_proto_depIdxs = []int32{
	1, // 0: eolymp.judge.Ticket.message:type_name -> eolymp.ecm.Content
	2, // 1: eolymp.judge.Ticket.created_at:type_name -> google.protobuf.Timestamp
