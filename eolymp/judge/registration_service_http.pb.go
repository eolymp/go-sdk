...
// _RegistrationService_WebsocketErrorResponse writes error to websocket connection
func _RegistrationService_WebsocketErrorResponse(conn *websocket.Conn, e error) {
...
// _RegistrationService_WebsocketCodec implements protobuf codec for websockets package
var _RegistrationService_WebsocketCodec = websocket.Codec{
