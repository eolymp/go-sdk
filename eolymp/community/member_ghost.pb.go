...
var file_eolymp_community_member_ghost_proto_rawDesc = string([]byte{
...
var (
	...
	file_eolymp_community_member_ghost_proto_rawDescData []byte
)
...
func file_eolymp_community_member_ghost_proto_rawDescGZIP() []byte {
	file_eolymp_community_member_ghost_proto_rawDescOnce.Do(func() {
		file_eolymp_community_member_ghost_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_eolymp_community_member_ghost_proto_rawDesc), len(file_eolymp_community_member_ghost_proto_rawDesc)))
	})
