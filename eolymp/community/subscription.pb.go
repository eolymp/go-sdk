...
type Subscription struct {
	...
	TaxName       uint32                  `protobuf:"varint,41,opt,name=tax_name,json=taxName,proto3" json:"tax_name,omitempty"`
...
func (x *Subscription) GetTaxName() uint32 {
	if x != nil {
		return x.TaxName
	}
	return 0
...
var file_eolymp_community_subscription_proto_rawDesc = []byte{
	...
	0x61, 0x6d, 0x65, 0x18, 0x29, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x07, 0x74, 0x61, 0x78, 0x4e, 0x61,
