...
type IdentityProvider_GoogleWorkspace struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ClientId      string                 `protobuf:"bytes,10,opt,name=client_id,json=clientId,proto3" json:"client_id,omitempty"`
	ClientSecret  string                 `protobuf:"bytes,11,opt,name=client_secret,json=clientSecret,proto3" json:"client_secret,omitempty"`
	Domain        string                 `protobuf:"bytes,20,opt,name=domain,proto3" json:"domain,omitempty"` // Required Google Workspace domain (hd parameter)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *IdentityProvider_GoogleWorkspace) Reset() {
	*x = IdentityProvider_GoogleWorkspace{}
	mi := &file_eolymp_community_configuration_idp_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *IdentityProvider_GoogleWorkspace) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IdentityProvider_GoogleWorkspace) ProtoMessage() {}

func (x *IdentityProvider_GoogleWorkspace) ProtoReflect() protoreflect.Message {
	mi := &file_eolymp_community_configuration_idp_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IdentityProvider_GoogleWorkspace.ProtoReflect.Descriptor instead.
func (*IdentityProvider_GoogleWorkspace) Descriptor() ([]byte, []int) {
	return file_eolymp_community_configuration_idp_proto_rawDescGZIP(), []int{0, 3}
}

func (x *IdentityProvider_GoogleWorkspace) GetClientId() string {
	if x != nil {
		return x.ClientId
	}
	return ""
...
func (x *IdentityProvider_GoogleWorkspace) GetClientSecret() string {
	if x != nil {
		return x.ClientSecret
	}
	return ""
...
func (x *IdentityProvider_GoogleWorkspace) GetDomain() string {
	if x != nil {
		return x.Domain
	}
	return ""
...
const file_eolymp_community_configuration_idp_proto_rawDesc = "" +
	"\n" +
	"(eolymp/community/configuration_idp.proto\x12\x10eolymp.community\"\x89\x05\n" +
	...
	"\fredirect_uri\x18\x19 \x01(\tR\vredirectUri\x1ak\n" +
	"\x0fGoogleWorkspace\x12\x1b\n" +
	"\tclient_id\x18\n" +
	" \x01(\tR\bclientId\x12#\n" +
	"\rclient_secret\x18\v \x01(\tR\fclientSecret\x12\x16\n" +
	"\x06domain\x18\x14 \x01(\tR\x06domainB5Z3github.com/eolymp/go-sdk/eolymp/community;communityb\x06proto3"
...
var file_eolymp_community_configuration_idp_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_eolymp_community_configuration_idp_proto_goTypes = []any{
	...
	(*IdentityProvider_GoogleWorkspace)(nil), // 4: eolymp.community.IdentityProvider.GoogleWorkspace
}
