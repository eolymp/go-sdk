...
type IdentityConfig struct {
	...
	//	*IdentityConfig_Oidc
	//	*IdentityConfig_GoogleWorkspace
...
func (x *IdentityConfig) GetGoogleWorkspace() *IdentityProvider_GoogleWorkspace {
	if x != nil {
		if x, ok := x.Provider.(*IdentityConfig_GoogleWorkspace); ok {
...
type IdentityConfig_GoogleWorkspace struct {
	GoogleWorkspace *IdentityProvider_GoogleWorkspace `protobuf:"bytes,4,opt,name=google_workspace,json=googleWorkspace,proto3,oneof"`
}
...
func (*IdentityConfig_GoogleWorkspace) isIdentityConfig_Provider() {}
...
const file_eolymp_community_configuration_identity_proto_rawDesc = "" +
	...
	"\x04oidc\x18\x03 \x01(\v2'.eolymp.community.IdentityProvider.OIDCH\x00R\x04oidc\x12_\n" +
	"\x10google_workspace\x18\x04 \x01(\v22.eolymp.community.IdentityProvider.GoogleWorkspaceH\x00R\x0fgoogleWorkspace\x12\\\n" +
...
var file_eolymp_community_configuration_identity_proto_goTypes = []any{
	...
	(*IdentityProvider_GoogleWorkspace)(nil), // 5: eolymp.community.IdentityProvider.GoogleWorkspace
}
var file_eolymp_community_configuration_identity_proto_depIdxs = []int32{
	...
	5, // 3: eolymp.community.IdentityConfig.google_workspace:type_name -> eolymp.community.IdentityProvider.GoogleWorkspace
	0, // 4: eolymp.community.IdentityConfig.display_name_type:type_name -> eolymp.community.IdentityConfig.DisplayNameType
...
func file_eolymp_community_configuration_identity_proto_init() {
	...
	file_eolymp_community_configuration_identity_proto_msgTypes[0].OneofWrappers = []any{
		...
		(*IdentityConfig_GoogleWorkspace)(nil),
	}
	type x struct{}
