...
type Member struct {
	...
	Identities       []*Member_Identity `protobuf:"bytes,10,rep,name=identities,proto3" json:"identities,omitempty"`
...
func (x *Member) GetIdentities() []*Member_Identity {
	if x != nil {
		return x.Identities
	}
	return nil
...
func (x *Member_Identity) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Member_Identity) ProtoMessage() {}

func (x *Member_Identity) ProtoReflect() protoreflect.Message {
	mi := &file_eolymp_community_member_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Member_Identity.ProtoReflect.Descriptor instead.
func (*Member_Identity) Descriptor() ([]byte, []int) {
	return file_eolymp_community_member_proto_rawDescGZIP(), []int{0, 0}
}

func (x *Member_Identity) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *Member_Identity) GetIssuer() string {
	if x != nil {
		return x.Issuer
	}
	return ""
...
func (x *Member_Identity) GetSubject() string {
	if x != nil {
		return x.Subject
	}
	return ""
...
func (x *Member_Identity) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *Member_Identity) GetNickname() string {
	if x != nil {
		return x.Nickname
	}
	return ""
...
func (x *Member_Identity) GetPicture() string {
	if x != nil {
		return x.Picture
	}
	return ""
...
func (x *Member_Identity) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
func (x *Member_Identity) GetEmailVerified() bool {
	if x != nil {
...
func (x *Member_Identity) GetProfile() string {
	if x != nil {
		return x.Profile
	}
	return ""
...
func (x *Member_Identity) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
var file_eolymp_community_member_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xe4, 0x07, 0x0a, 0x06, 0x4d, 0x65, 0x6d, 0x62, 0x65,
	...
	0x74, 0x75, 0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x41, 0x0a, 0x0a, 0x69,
	...
	0x74, 0x79, 0x2e, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x2e, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69,
	0x74, 0x79, 0x52, 0x0a, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x69, 0x65, 0x73, 0x12, 0x36,
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x1a, 0x89, 0x02, 0x0a, 0x08, 0x49, 0x64, 0x65, 0x6e, 0x74,
	...
	0x62, 0x6a, 0x65, 0x63, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x04, 0x20,
	...
	0x72, 0x64, 0x18, 0x64, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f,
	0x72, 0x64, 0x1a, 0xbb, 0x01, 0x0a, 0x05, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x23, 0x0a, 0x0d,
	...
	,
...
var file_eolymp_community_member_proto_goTypes = []interface{}{
	...
	(*Member_Identity)(nil), // 2: eolymp.community.Member.Identity
...
var file_eolymp_community_member_proto_depIdxs = []int32{
	...
	2, // 1: eolymp.community.Member.identities:type_name -> eolymp.community.Member.Identity
