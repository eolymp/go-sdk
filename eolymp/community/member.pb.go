...
type Member struct {
	...
	RankLength     int32                  `protobuf:"varint,72,opt,name=rank_length,json=rankLength,proto3" json:"rank_length,omitempty"`
...
func (x *Member) GetRankLength() int32 {
	if x != nil {
		return x.RankLength
	}
	return 0
...
var file_eolymp_community_member_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x67, 0x74, 0x68, 0x18, 0x48, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x72, 0x61, 0x6e,
	0x6b, 0x4c, 0x65, 0x6e, 0x67, 0x74, 0x68, 0x12, 0x14, 0x0a, 0x05, 0x73, 0x63, 0x6f, 0x72, 0x65,
	0x18, 0x47, 0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x12, 0x16, 0x0a,
