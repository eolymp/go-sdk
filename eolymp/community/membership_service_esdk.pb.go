...
type _MembershipServiceHttpClient interface {
	Do(*http.Request) (*http.Response, error)
}

type MembershipServiceService struct {
	base string
	cli  _MembershipServiceHttpClient
}
...
func NewMembershipServiceHttpClient(url string, cli _MembershipServiceHttpClient) *MembershipServiceService {
	...
	return &MembershipServiceService{base: url, cli: cli}
}

func (s *MembershipServiceService) do(ctx context.Context, verb, path string, in, out proto.Message) (err error) {
	var body io.Reader
...
func (s *MembershipServiceService) UpdateMembership(ctx context.Context, in *UpdateMembershipInput) (*UpdateMembershipOutput, error) {
