...
const file_eolymp_community_member_service_proto_rawDesc = "" +
	"\n" +
	"%eolymp/community/member_service.proto\x12\x10eolymp.community\x1a\x1deolymp/annotations/http.proto\x1a\"eolymp/annotations/ratelimit.proto\x1a\x1eeolymp/annotations/scope.proto\x1a!eolymp/community/email_type.proto\x1a\x1deolymp/community/member.proto\x1a\x18eolymp/ecm/content.proto\x1a eolymp/wellknown/direction.proto\x1a!eolymp/wellknown/expression.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"v\n" +
	...
	"\tmember_id\x18\x01 \x01(\tR\bmemberId\"\xde\x04\n" +
	"\x11UpdateMemberInput\x12?\n" +
	"\x05patch\x18\x01 \x03(\x0e2).eolymp.community.UpdateMemberInput.PatchR\x05patch\x12\x1b\n" +
	"\tmember_id\x18\x02 \x01(\tR\bmemberId\x120\n" +
	"\x06member\x18\x03 \x01(\v2\x18.eolymp.community.MemberR\x06member\"\xb8\x03\n" +
	"\x05Patch\x12\a\n" +
	...
	"\x05extra\x18\xe3\b \x03(\x0e2\x1e.eolymp.community.Member.ExtraR\x05extra\"H\n" +
	"\x14DescribeMemberOutput\x120\n" +
	"\x06member\x18\x01 \x01(\v2\x18.eolymp.community.MemberR\x06member\"\xd3\r\n" +
	...
	"\x05extra\x18\xe3\b \x03(\x0e2\x1e.eolymp.community.Member.ExtraR\x05extra\x1a\xaf\x01\n" +
	...
	"\x06string\x18\v \x01(\v2\".eolymp.wellknown.ExpressionStringR\x06string\x1a\x88\t\n" +
	"\x06Filter\x12.\n" +
