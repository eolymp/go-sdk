...
func file_eolymp_community_attribute_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_eolymp_community_attribute_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	file_eolymp_community_attribute_proto_msgTypes[2].OneofWrappers = []interface{}{
