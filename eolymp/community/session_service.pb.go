...
var file_eolymp_community_session_service_proto_rawDesc = []byte{
...
var (
	...
	file_eolymp_community_session_service_proto_rawDescData = file_eolymp_community_session_service_proto_rawDesc
)
...
func file_eolymp_community_session_service_proto_rawDescGZIP() []byte {
	file_eolymp_community_session_service_proto_rawDescOnce.Do(func() {
		file_eolymp_community_session_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_eolymp_community_session_service_proto_rawDescData)
	})
...
func file_eolymp_community_session_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_eolymp_community_session_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_eolymp_community_session_service_proto_rawDesc = nil
