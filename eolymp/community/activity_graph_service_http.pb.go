...
// _ActivityGraphService_WebsocketErrorResponse writes error to websocket connection
func _ActivityGraphService_WebsocketErrorResponse(conn *websocket.Conn, e error) {
...
// _ActivityGraphService_WebsocketCodec implements protobuf codec for websockets package
var _ActivityGraphService_WebsocketCodec = websocket.Codec{
