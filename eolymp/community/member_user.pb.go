...
const file_eolymp_community_member_user_proto_rawDesc = "" +
	"\n" +
	"\"eolymp/community/member_user.proto\x12\x10eolymp.community\x1a!eolymp/community/email_type.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xd2\x05\n" +
	"\x04User\x12\x16\n" +
	"\x06issuer\x18\x01 \x01(\tR\x06issuer\x12\x18\n" +
	"\asubject\x18\x02 \x01(\tR\asubject\x12\x1a\n" +
	"\bnickname\x18\n" +
	" \x01(\tR\bnickname\x126\n" +
	"\x17nickname_change_timeout\x18\v \x01(\rR\x15nicknameChangeTimeout\x12\x14\n" +
	...
	"\aruntime\x18\n" +
	" \x01(\tR\aruntimeB5Z3github.com/eolymp/go-sdk/eolymp/community;communityb\x06proto3"
