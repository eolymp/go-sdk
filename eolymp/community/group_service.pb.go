...
const file_eolymp_community_group_service_proto_rawDesc = "" +
	...
	"\x10UpdateGroupInput\x12>\n" +
	"\x05patch\x18\x01 \x03(\x0e2(.eolymp.community.UpdateGroupInput.PatchR\x05patch\x12\x19\n" +
	"\bgroup_id\x18\x02 \x01(\tR\agroupId\x12-\n" +
	"\x05group\x18\x03 \x01(\v2\x17.eolymp.community.GroupR\x05group\"+\n" +
	"\x05Patch\x12\a\n" +
	"\x03ALL\x10\x00\x12\b\n" +
	"\x04NAME\x10\x01\x12\x0f\n" +
	"\vDESCRIPTION\x10\x02\"\x13\n" +
	...
	"\x05group\x18\x01 \x01(\v2\x17.eolymp.community.GroupR\x05group\"\x8a\x02\n" +
	"\x0fListGroupsInput\x12\x16\n" +
	"\x06offset\x18\n" +
	" \x01(\x05R\x06offset\x12\x12\n" +
	"\x04size\x18\v \x01(\x05R\x04size\x12B\n" +
	"\afilters\x18( \x01(\v2(.eolymp.community.ListGroupsInput.FilterR\afilters\x1a\x86\x01\n" +
	"\x06Filter\x12\x14\n" +
