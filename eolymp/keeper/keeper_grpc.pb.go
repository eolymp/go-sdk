...
func (c *keeperClient) CreateObject(ctx context.Context, in *CreateObjectInput, opts ...grpc.CallOption) (*CreateObjectOutput, error) {
	...
	err := c.cc.Invoke(ctx, Keeper_CreateObject_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *keeperClient) DescribeObject(ctx context.Context, in *DescribeObjectInput, opts ...grpc.CallOption) (*DescribeObjectOutput, error) {
	...
	err := c.cc.Invoke(ctx, Keeper_DescribeObject_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *keeperClient) DownloadObject(ctx context.Context, in *DownloadObjectInput, opts ...grpc.CallOption) (*DownloadObjectOutput, error) {
	...
	err := c.cc.Invoke(ctx, Keeper_DownloadObject_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *keeperClient) StartMultipartUpload(ctx context.Context, in *StartMultipartUploadInput, opts ...grpc.CallOption) (*StartMultipartUploadOutput, error) {
	...
	err := c.cc.Invoke(ctx, Keeper_StartMultipartUpload_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *keeperClient) UploadPart(ctx context.Context, in *UploadPartInput, opts ...grpc.CallOption) (*UploadPartOutput, error) {
	...
	err := c.cc.Invoke(ctx, Keeper_UploadPart_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *keeperClient) CompleteMultipartUpload(ctx context.Context, in *CompleteMultipartUploadInput, opts ...grpc.CallOption) (*CompleteMultipartUploadOutput, error) {
	...
	err := c.cc.Invoke(ctx, Keeper_CompleteMultipartUpload_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
