...
type _ProjectServiceHttpClient interface {
	Do(*http.Request) (*http.Response, error)
}

type ProjectServiceService struct {
	base string
	cli  _ProjectServiceHttpClient
}
...
func NewProjectServiceHttpClient(url string, cli _ProjectServiceHttpClient) *ProjectServiceService {
	...
	return &ProjectServiceService{base: url, cli: cli}
}

func (s *ProjectServiceService) do(ctx context.Context, verb, path string, in, out proto.Message) (err error) {
	var body io.Reader
...
func (s *ProjectServiceService) ListProjects(ctx context.Context, in *ListProjectsInput) (*ListProjectsOutput, error) {
...
func (s *ProjectServiceService) DescribeProject(ctx context.Context, in *DescribeProjectInput) (*DescribeProjectOutput, error) {
	out := &DescribeProjectOutput{}
	path := "/projects/" + url.PathEscape(in.GetProjectId())
