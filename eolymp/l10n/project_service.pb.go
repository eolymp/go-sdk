...
func file_eolymp_l10n_project_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_eolymp_l10n_project_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_eolymp_l10n_project_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_eolymp_l10n_project_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_eolymp_l10n_project_service_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_eolymp_l10n_project_service_proto_msgTypes[4].Exporter = func(v any, i int) any {
