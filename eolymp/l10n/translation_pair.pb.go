...
var file_eolymp_l10n_translation_pair_proto_rawDesc = []byte{
	...
	0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa6, 0x01, 0x0a, 0x0f, 0x54, 0x72,
	0x61, 0x6e, 0x73, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x61, 0x69, 0x72, 0x12, 0x25, 0x0a,
	...
	0x74, 0x65, 0x72, 0x6d, 0x12, 0x30, 0x0a, 0x06, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x65, 0x6f, 0x6c, 0x79, 0x6d, 0x70, 0x2e, 0x6c, 0x31,
	0x30, 0x6e, 0x2e, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x06,
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x3a, 0x0a, 0x0b, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x6c,
...
var (
	...
	file_eolymp_l10n_translation_pair_proto_rawDescData = file_eolymp_l10n_translation_pair_proto_rawDesc
)

func file_eolymp_l10n_translation_pair_proto_rawDescGZIP() []byte {
	file_eolymp_l10n_translation_pair_proto_rawDescOnce.Do(func() {
		file_eolymp_l10n_translation_pair_proto_rawDescData = protoimpl.X.CompressGZIP(file_eolymp_l10n_translation_pair_proto_rawDescData)
	})
...
var file_eolymp_l10n_translation_pair_proto_goTypes = []interface{}{
...
func file_eolymp_l10n_translation_pair_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_eolymp_l10n_translation_pair_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TranslationPair); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_eolymp_l10n_translation_pair_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_eolymp_l10n_translation_pair_proto_rawDesc = nil
