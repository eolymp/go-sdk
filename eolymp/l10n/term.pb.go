...
var file_eolymp_l10n_term_proto_rawDesc = []byte{
	...
	0x2e, 0x6c, 0x31, 0x30, 0x6e, 0x22, 0xc2, 0x01, 0x0a, 0x04, 0x54, 0x65, 0x72, 0x6d, 0x12, 0x0e,
	...
	0x61, 0x74, 0x75, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x18, 0x2e, 0x65, 0x6f, 0x6c,
	0x79, 0x6d, 0x70, 0x2e, 0x6c, 0x31, 0x30, 0x6e, 0x2e, 0x54, 0x65, 0x72, 0x6d, 0x2e, 0x53, 0x74,
	...
	0x44, 0x45, 0x50, 0x52, 0x45, 0x43, 0x41, 0x54, 0x45, 0x44, 0x10, 0x02, 0x12, 0x0c, 0x0a, 0x08,
	0x4f, 0x55, 0x54, 0x44, 0x41, 0x54, 0x45, 0x44, 0x10, 0x03, 0x42, 0x2b, 0x5a, 0x29, 0x67, 0x69,
...
var (
	...
	file_eolymp_l10n_term_proto_rawDescData = file_eolymp_l10n_term_proto_rawDesc
)

func file_eolymp_l10n_term_proto_rawDescGZIP() []byte {
	file_eolymp_l10n_term_proto_rawDescOnce.Do(func() {
		file_eolymp_l10n_term_proto_rawDescData = protoimpl.X.CompressGZIP(file_eolymp_l10n_term_proto_rawDescData)
	})
...
var file_eolymp_l10n_term_proto_goTypes = []interface{}{
...
func file_eolymp_l10n_term_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_eolymp_l10n_term_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Term); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_eolymp_l10n_term_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_eolymp_l10n_term_proto_rawDesc = nil
