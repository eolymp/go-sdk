...
func (s *ConfigurationServiceService) DescribeRuntimeConfig(ctx context.Context, in *DescribeRuntimeConfigInput) (*DescribeRuntimeConfigOutput, error) {
	out := &DescribeRuntimeConfigOutput{}
...
func (s *ConfigurationServiceService) ConfigureRuntimeConfig(ctx context.Context, in *ConfigureRuntimeConfigInput) (*ConfigureRuntimeConfigOutput, error) {
	out := &ConfigureRuntimeConfigOutput{}
	path := "/configs/runtime"
