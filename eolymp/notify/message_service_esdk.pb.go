...
func (s *MessageServiceService) CreateMessage(ctx context.Context, in *CreateMessageInput) (*CreateMessageOutput, error) {
	out := &CreateMessageOutput{}
	path := "/messages"
...
func (s *MessageServiceService) PublishMessage(ctx context.Context, in *PublishMessageInput) (*PublishMessageOutput, error) {
	out := &PublishMessageOutput{}
	path := "/messages/" + url.PathEscape(in.GetMessageId()) + "/publish"
