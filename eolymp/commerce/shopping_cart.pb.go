...
type ShoppingCart struct {
	...
	ShippingMethodId      string                 `protobuf:"bytes,50,opt,name=shipping_method_id,json=shippingMethodId,proto3" json:"shipping_method_id,omitempty"`
...
func (x *ShoppingCart) GetShippingMethodId() string {
	if x != nil {
...
const file_eolymp_commerce_shopping_cart_proto_rawDesc = "" +
	...
	"\x12shipping_method_id\x182 \x01(\tR\x10shippingMethodId\x12!\n" +
