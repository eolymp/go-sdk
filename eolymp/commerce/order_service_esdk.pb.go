...
func (s *OrderServiceService) CancelOrder(ctx context.Context, in *CancelOrderInput) (*CancelOrderOutput, error) {
	...
	path := "/store/orders/" + url.PathEscape(in.GetOrderId()) + "/cancel"
...
func (s *OrderServiceService) ListOrders(ctx context.Context, in *ListOrdersInput) (*ListOrdersOutput, error) {
