...
type Invoice_Item struct {
	...
	Currency               string                    `protobuf:"bytes,100,opt,name=currency,proto3" json:"currency,omitempty"`
	Amount                 uint32                    `protobuf:"varint,101,opt,name=amount,proto3" json:"amount,omitempty"`
	AmountExcludingTax     uint32                    `protobuf:"varint,102,opt,name=amount_excluding_tax,json=amountExcludingTax,proto3" json:"amount_excluding_tax,omitempty"`
	UnitAmountExcludingTax uint32                    `protobuf:"varint,103,opt,name=unit_amount_excluding_tax,json=unitAmountExcludingTax,proto3" json:"unit_amount_excluding_tax,omitempty"`
...
func (x *Invoice_Item) GetAmount() uint32 {
	if x != nil {
		return x.Amount
	}
	return 0
...
func (x *Invoice_Item) GetAmountExcludingTax() uint32 {
	if x != nil {
...
func (x *Invoice_Item) GetUnitAmountExcludingTax() uint32 {
	if x != nil {
...
type Invoice_TaxAmount struct {
	...
	TaxableAmount    uint32 `protobuf:"varint,10,opt,name=taxable_amount,json=taxableAmount,proto3" json:"taxable_amount,omitempty"`
}
...
func (x *Invoice_TaxAmount) GetAmount() uint32 {
	if x != nil {
		return x.Amount
	}
	return 0
...
func (x *Invoice_TaxAmount) GetTaxableAmount() uint32 {
	if x != nil {
...
func (x *Invoice_DiscountAmount) GetAmount() uint32 {
	if x != nil {
		return x.Amount
	}
	return 0
...
var file_eolymp_commerce_invoice_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x0d, 0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x30, 0x0a, 0x14, 0x61,
	0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x5f, 0x65, 0x78, 0x63, 0x6c, 0x75, 0x64, 0x69, 0x6e, 0x67, 0x5f,
	0x74, 0x61, 0x78, 0x18, 0x66, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x12, 0x61, 0x6d, 0x6f, 0x75, 0x6e,
	...
	0x6c, 0x75, 0x64, 0x69, 0x6e, 0x67, 0x5f, 0x74, 0x61, 0x78, 0x18, 0x67, 0x20, 0x01, 0x28, 0x0d,
	...
	0x0a, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0d, 0x74, 0x61, 0x78, 0x61, 0x62, 0x6c, 0x65, 0x41, 0x6d,
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x1a,
