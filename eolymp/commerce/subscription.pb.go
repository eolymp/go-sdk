...
type Subscription_Item struct {
	...
	PriceId   string `protobuf:"bytes,21,opt,name=price_id,json=priceId,proto3" json:"price_id,omitempty"`
}
...
func (x *Subscription_Item) GetPriceId() string {
	if x != nil {
		return x.PriceId
	}
	return ""
...
var file_eolymp_commerce_subscription_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xe3, 0x08, 0x0a, 0x0c, 0x53, 0x75, 0x62, 0x73, 0x63,
	...
	0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x1a, 0x68, 0x0a, 0x04, 0x49, 0x74, 0x65, 0x6d, 0x12,
	...
	0x69, 0x64, 0x18, 0x15, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x70, 0x72, 0x69, 0x63, 0x65, 0x49,
	0x64, 0x22, 0x50, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x12, 0x0a, 0x0e, 0x55,
	...
	0x44, 0x10, 0x04, 0x42, 0x07, 0x0a, 0x05, 0x70, 0x61, 0x79, 0x65, 0x72, 0x42, 0x33, 0x5a, 0x31,
...
var file_eolymp_commerce_subscription_proto_depIdxs = []int32{
	...
	3, // 3: eolymp.commerce.Subscription.cancelled_at:type_name -> google.protobuf.Timestamp
	3, // 4: eolymp.commerce.Subscription.period_start:type_name -> google.protobuf.Timestamp
	3, // 5: eolymp.commerce.Subscription.period_end:type_name -> google.protobuf.Timestamp
	2, // 6: eolymp.commerce.Subscription.items:type_name -> eolymp.commerce.Subscription.Item
