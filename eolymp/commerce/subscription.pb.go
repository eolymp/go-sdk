...
type Subscription struct {
	...
	TrialStart           *timestamppb.Timestamp `protobuf:"bytes,70,opt,name=trial_start,json=trialStart,proto3" json:"trial_start,omitempty"`    // time when trial has started
	TrialEnd             *timestamppb.Timestamp `protobuf:"bytes,71,opt,name=trial_end,json=trialEnd,proto3" json:"trial_end,omitempty"`          // time when trial will be over
...
func (x *Subscription_Item) GetQuantity() int32 {
	if x != nil {
		return x.Quantity
	}
	return 0
