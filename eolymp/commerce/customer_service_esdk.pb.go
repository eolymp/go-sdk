...
type _CustomerServiceHttpClient interface {
	Do(*http.Request) (*http.Response, error)
}

type CustomerServiceService struct {
	base string
	cli  _CustomerServiceHttpClient
}

// NewCustomerServiceHttpClient constructs client for CustomerService
func NewCustomerServiceHttpClient(url string, cli _CustomerServiceHttpClient) *CustomerServiceService {
	if url == "" {
	...
	return &CustomerServiceService{base: url, cli: cli}
}

func (s *CustomerServiceService) do(ctx context.Context, verb, path string, in, out proto.Message) (err error) {
	var body io.Reader
