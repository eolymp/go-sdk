...
const file_eolymp_commerce_price_proto_rawDesc = "" +
	"\n" +
	"\x1beolymp/commerce/price.proto\x12\x0feolymp.commerce\"\xe3\x01\n" +
	"\x05Price\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12A\n" +
	"\n" +
	"recurrence\x18\x03 \x01(\x0e2!.eolymp.commerce.Price.RecurrenceR\n" +
	"recurrence\x12\x1a\n" +
	...
	"\n" +
	"\x06YEARLY\x10\x03B3Z1github.com/eolymp/go-sdk/eolymp/commerce;commerceb\x06proto3"

var (
	file_eolymp_commerce_price_proto_rawDescOnce sync.Once
	file_eolymp_commerce_price_proto_rawDescData []byte
)

func file_eolymp_commerce_price_proto_rawDescGZIP() []byte {
	file_eolymp_commerce_price_proto_rawDescOnce.Do(func() {
		file_eolymp_commerce_price_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_eolymp_commerce_price_proto_rawDesc), len(file_eolymp_commerce_price_proto_rawDesc)))
	})
...
func file_eolymp_commerce_price_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_eolymp_commerce_price_proto_rawDesc), len(file_eolymp_commerce_price_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
