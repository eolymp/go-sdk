...
var errFulfillmentServiceRequestTooLarge = errors.New("request too large")

// _FulfillmentService_HTTPInvalidArgument wraps a request parsing error into an InvalidArgument status
// with structured details so it is reported as HTTP 400 instead of 500.
func _FulfillmentService_HTTPInvalidArgument(err error) error {
...
// _FulfillmentService_HTTPReadQueryString parses query string into proto.Message with size limit
func _FulfillmentService_HTTPReadQueryString(r *http.Request, v proto.Message, maxSize int64) error {
	if int64(len(r.URL.RawQuery)) > maxSize {
		return errFulfillmentServiceRequestTooLarge
	}

	if h := r.Header.Values("Strict-Parsing"); len(h) > 0 {
		strict, err := strconv.ParseBool(h[len(h)-1])
		if err != nil {
			return _FulfillmentService_HTTPInvalidArgument(err)
		}
...
// _FulfillmentService_HTTPReadRequestBody parses body into proto.Message with size limit
func _FulfillmentService_HTTPReadRequestBody(r *http.Request, v proto.Message, maxSize int64) error {
...
// _FulfillmentService_HTTPReadRequest reads request parameters from the body when it is present,
// otherwise it falls back to the query string. Used for verbs (DELETE) that may carry parameters either way.
func _FulfillmentService_HTTPReadRequest(r *http.Request, v proto.Message, bodyMaxSize, queryMaxSize int64) error {
	...
	return _FulfillmentService_HTTPReadQueryString(r, v, queryMaxSize)
}

// _FulfillmentService_HTTPWriteResponse writes proto.Message to HTTP response
func _FulfillmentService_HTTPWriteResponse(w http.ResponseWriter, v proto.Message, h, t metadata.MD) {
...
// _FulfillmentService_HTTPWriteErrorResponse writes error to HTTP response with error status code
func _FulfillmentService_HTTPWriteErrorResponse(w http.ResponseWriter, e error) {
	s := status.Convert(e)

	if e == errFulfillmentServiceRequestTooLarge {
...
// RegisterFulfillmentServiceHttpHandlers adds handlers for for FulfillmentServiceClient
func RegisterFulfillmentServiceHttpHandlers(router *mux.Router, prefix string, cli FulfillmentServiceClient) {
	...
	router.Handle(prefix+"/store/orders/{order_id}/process", _FulfillmentService_ProcessOrder_Rule0(cli)).
		Methods("POST").
		Name("eolymp.commerce.FulfillmentService.ProcessOrder")
	router.Handle(prefix+"/store/orders/{order_id}/ship", _FulfillmentService_ShipOrder_Rule0(cli)).
		Methods("POST").
		Name("eolymp.commerce.FulfillmentService.ShipOrder")
...
func RegisterFulfillmentServiceHttpProxy(router *mux.Router, prefix string, conn grpc.ClientConnInterface) {
	RegisterFulfillmentServiceHttpHandlers(router, prefix, NewFulfillmentServiceClient(conn))
}

func _FulfillmentService_AllocateStock_Rule0(cli FulfillmentServiceClient) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		in := &AllocateStockInput{}
...
func _FulfillmentService_ProcessOrder_Rule0(cli FulfillmentServiceClient) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		in := &ProcessOrderInput{}
		...
		out, err := cli.ProcessOrder(r.Context(), in, grpc.Header(&header), grpc.Trailer(&trailer))
		if err != nil {
			_FulfillmentService_HTTPWriteErrorResponse(w, err)
			return
		}
...
func _FulfillmentService_ShipOrder_Rule0(cli FulfillmentServiceClient) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		in := &ShipOrderInput{}
		...
		out, err := cli.ShipOrder(r.Context(), in, grpc.Header(&header), grpc.Trailer(&trailer))
		if err != nil {
			_FulfillmentService_HTTPWriteErrorResponse(w, err)
			return
		}
...
func _FulfillmentService_CompleteOrder_Rule0(cli FulfillmentServiceClient) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
