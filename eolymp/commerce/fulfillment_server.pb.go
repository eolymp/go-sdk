...
type MarkReturnedOrderInput struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	OrderId       string                 `protobuf:"bytes,1,opt,name=order_id,json=orderId,proto3" json:"order_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *MarkReturnedOrderInput) Reset() {
	*x = MarkReturnedOrderInput{}
	mi := &file_eolymp_commerce_fulfillment_server_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *MarkReturnedOrderInput) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MarkReturnedOrderInput) ProtoMessage() {}

func (x *MarkReturnedOrderInput) ProtoReflect() protoreflect.Message {
	mi := &file_eolymp_commerce_fulfillment_server_proto_msgTypes[10]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MarkReturnedOrderInput.ProtoReflect.Descriptor instead.
func (*MarkReturnedOrderInput) Descriptor() ([]byte, []int) {
	return file_eolymp_commerce_fulfillment_server_proto_rawDescGZIP(), []int{10}
}

func (x *MarkReturnedOrderInput) GetOrderId() string {
	if x != nil {
		return x.OrderId
	}
	return ""
...
type MarkReturnedOrderOutput struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *MarkReturnedOrderOutput) Reset() {
	*x = MarkReturnedOrderOutput{}
	mi := &file_eolymp_commerce_fulfillment_server_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *MarkReturnedOrderOutput) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MarkReturnedOrderOutput) ProtoMessage() {}

func (x *MarkReturnedOrderOutput) ProtoReflect() protoreflect.Message {
	mi := &file_eolymp_commerce_fulfillment_server_proto_msgTypes[11]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MarkReturnedOrderOutput.ProtoReflect.Descriptor instead.
func (*MarkReturnedOrderOutput) Descriptor() ([]byte, []int) {
