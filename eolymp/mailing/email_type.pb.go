...
var file_eolymp_mailing_email_type_proto_rawDesc = string([]byte{
...
var (
	...
	file_eolymp_mailing_email_type_proto_rawDescData []byte
)

func file_eolymp_mailing_email_type_proto_rawDescGZIP() []byte {
	file_eolymp_mailing_email_type_proto_rawDescOnce.Do(func() {
		file_eolymp_mailing_email_type_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_eolymp_mailing_email_type_proto_rawDesc), len(file_eolymp_mailing_email_type_proto_rawDesc)))
	})
...
func file_eolymp_mailing_email_type_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_eolymp_mailing_email_type_proto_rawDesc), len(file_eolymp_mailing_email_type_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
