...
type Statement struct {
	...
	Automatic    string       `protobuf:"bytes,8,opt,name=automatic,proto3" json:"automatic,omitempty"` // if true means the statement was created automatically (probably translation from another language)
...
func (x *Statement) GetAutomatic() string {
	if x != nil {
		return x.Automatic
	}
	return ""
...
var file_eolymp_atlas_statement_proto_rawDesc = []byte{
	...
	0x61, 0x75, 0x74, 0x6f, 0x6d, 0x61, 0x74, 0x69, 0x63, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52,
