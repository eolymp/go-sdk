...
func (s *ConfigurationServiceService) ConfigurePolygon(ctx context.Context, in *ConfigurePolygonInput) (*ConfigurePolygonOutput, error) {
	out := &ConfigurePolygonOutput{}
	path := "/config/polygon"
...
func (s *ConfigurationServiceService) DescribePolygon(ctx context.Context, in *DescribePolygonInput) (*DescribePolygonOutput, error) {
	out := &DescribePolygonOutput{}
	path := "/config/polygon"
