...
func (s *ConfigurationServiceService) DescribeConfig(ctx context.Context, in *DescribeConfigInput) (*DescribeConfigOutput, error) {
	out := &DescribeConfigOutput{}
	path := "/configs/atlas"
...
func (s *ConfigurationServiceService) UpdateConfig(ctx context.Context, in *UpdateConfigInput) (*UpdateConfigOutput, error) {
