...
type _AttachmentServiceHttpClient interface {
	Do(*http.Request) (*http.Response, error)
}

type AttachmentServiceService struct {
	base string
	cli  _AttachmentServiceHttpClient
}
...
func NewAttachmentServiceHttpClient(url string, cli _AttachmentServiceHttpClient) *AttachmentServiceService {
	...
	return &AttachmentServiceService{base: url, cli: cli}
}

func (s *AttachmentServiceService) do(ctx context.Context, verb, path string, in, out proto.Message) (err error) {
	var body io.Reader
