...
const file_eolymp_atlas_editor_service_proto_rawDesc = "" +
	...
	"\bruntimes\x18\v \x03(\v2\x17.eolymp.runtime.RuntimeR\bruntimes\x1aa\n" +
	"\x05State\x12\x18\n" +
	...
	"\x18DescribeEditorStateInput\"\xaf\x01\n" +
	"\x19DescribeEditorStateOutput\x12\x18\n" +
	"\aruntime\x18\x01 \x01(\tR\aruntime\x12\x1f\n" +
	"\vsource_code\x18\x02 \x01(\tR\n" +
	"sourceCode\x12\x1d\n" +
	"\n" +
	"input_data\x18\x03 \x01(\tR\tinputData\x128\n" +
	"\bfeatures\x18\n" +
	" \x03(\x0e2\x1c.eolymp.atlas.Editor.FeatureR\bfeatures\"r\n" +
	"\x16UpdateEditorStateInput\x12\x18\n" +
	"\aruntime\x18\x01 \x01(\tR\aruntime\x12\x1f\n" +
	"\vsource_code\x18\x02 \x01(\tR\n" +
	"sourceCode\x12\x1d\n" +
	"\n" +
	"input_data\x18\x03 \x01(\tR\tinputData\"\x19\n" +
