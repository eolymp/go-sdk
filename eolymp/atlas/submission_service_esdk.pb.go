...
type _SubmissionServiceHttpClient interface {
	Do(*http.Request) (*http.Response, error)
}

type SubmissionServiceService struct {
	base string
	cli  _SubmissionServiceHttpClient
}
...
func NewSubmissionServiceHttpClient(url string, cli _SubmissionServiceHttpClient) *SubmissionServiceService {
	...
	return &SubmissionServiceService{base: url, cli: cli}
}

func (s *SubmissionServiceService) do(ctx context.Context, verb, path string, in, out proto.Message) (err error) {
	var body io.Reader
