...
type Submission_Group_ScoringMode int32

const (
	Submission_Group_NONE Submission_Group_ScoringMode = 0 // no score is awarded for passing tests from this group
	Submission_Group_EACH Submission_Group_ScoringMode = 1 // scores are awarded for passing each individual runs
	Submission_Group_ALL  Submission_Group_ScoringMode = 2 // scores are only awarded if all runs are passing
)

// Enum value maps for Submission_Group_ScoringMode.
var (
	Submission_Group_ScoringMode_name = map[int32]string{
		0: "NONE",
		1: "EACH",
		2: "ALL",
	}
	Submission_Group_ScoringMode_value = map[string]int32{
		"NONE": 0,
		"EACH": 1,
		"ALL":  2,
	}
...
func (x Submission_Group_ScoringMode) Enum() *Submission_Group_ScoringMode {
	p := new(Submission_Group_ScoringMode)
	*p = x
	return p
}

func (x Submission_Group_ScoringMode) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Submission_Group_ScoringMode) Descriptor() protoreflect.EnumDescriptor {
	return file_eolymp_atlas_submission_proto_enumTypes[3].Descriptor()
}

func (Submission_Group_ScoringMode) Type() protoreflect.EnumType {
	return &file_eolymp_atlas_submission_proto_enumTypes[3]
}

func (x Submission_Group_ScoringMode) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Submission_Group_ScoringMode.Descriptor instead.
func (Submission_Group_ScoringMode) EnumDescriptor() ([]byte, []int) {
	return file_eolymp_atlas_submission_proto_rawDescGZIP(), []int{0, 1, 1}
}

type Submission_Group_FeedbackPolicy int32

const (
	Submission_Group_COMPLETE Submission_Group_FeedbackPolicy = 0 // show each test individually
	Submission_Group_ICPC     Submission_Group_FeedbackPolicy = 1 // show results as in ICPC contest (only first not accepted test from the set)
)

// Enum value maps for Submission_Group_FeedbackPolicy.
var (
	Submission_Group_FeedbackPolicy_name = map[int32]string{
		0: "COMPLETE",
		1: "ICPC",
	}
	Submission_Group_FeedbackPolicy_value = map[string]int32{
		"COMPLETE": 0,
		"ICPC":     1,
	}
)

func (x Submission_Group_FeedbackPolicy) Enum() *Submission_Group_FeedbackPolicy {
	p := new(Submission_Group_FeedbackPolicy)
	*p = x
	return p
}

func (x Submission_Group_FeedbackPolicy) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Submission_Group_FeedbackPolicy) Descriptor() protoreflect.EnumDescriptor {
	return file_eolymp_atlas_submission_proto_enumTypes[4].Descriptor()
}

func (Submission_Group_FeedbackPolicy) Type() protoreflect.EnumType {
	return &file_eolymp_atlas_submission_proto_enumTypes[4]
}

func (x Submission_Group_FeedbackPolicy) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Submission_Group_FeedbackPolicy.Descriptor instead.
func (Submission_Group_FeedbackPolicy) EnumDescriptor() ([]byte, []int) {
	return file_eolymp_atlas_submission_proto_rawDescGZIP(), []int{0, 1, 2}
}
...
type Submission struct {
	...
	SubmittedAt   *timestamp.Timestamp `protobuf:"bytes,5,opt,name=submitted_at,json=submittedAt,proto3" json:"submitted_at,omitempty"`          // time when submission was created
...
type Submission_Group struct {
	...
	ScoringMode    Submission_Group_ScoringMode    `protobuf:"varint,22,opt,name=scoring_mode,json=scoringMode,proto3,enum=eolymp.atlas.Submission_Group_ScoringMode" json:"scoring_mode,omitempty"`             // how group is scored
	FeedbackPolicy Submission_Group_FeedbackPolicy `protobuf:"varint,30,opt,name=feedback_policy,json=feedbackPolicy,proto3,enum=eolymp.atlas.Submission_Group_FeedbackPolicy" json:"feedback_policy,omitempty"` // how tests are shown to the user
...
func (x *Submission_Group) GetScoringMode() Submission_Group_ScoringMode {
	if x != nil {
		return x.ScoringMode
	}
	return Submission_Group_NONE
}

func (x *Submission_Group) GetFeedbackPolicy() Submission_Group_FeedbackPolicy {
	if x != nil {
		return x.FeedbackPolicy
	}
	return Submission_Group_COMPLETE
}
...
var file_eolymp_atlas_submission_proto_rawDesc = []byte{
	...
	0x0c, 0x65, 0x6f, 0x6c, 0x79, 0x6d, 0x70, 0x2e, 0x61, 0x74, 0x6c, 0x61, 0x73, 0x1a, 0x1f, 0x67,
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2f, 0x74,
	0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x97,
	0x10, 0x0a, 0x0a, 0x53, 0x75, 0x62, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x0e, 0x0a,
	...
	0x65, 0x64, 0x41, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x6c, 0x61, 0x6e, 0x67, 0x18, 0x0a, 0x20, 0x01,
	...
	0x18, 0x15, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x12, 0x0a,
	0x04, 0x63, 0x6f, 0x73, 0x74, 0x18, 0x1e, 0x20, 0x01, 0x28, 0x02, 0x52, 0x04, 0x63, 0x6f, 0x73,
	0x74, 0x12, 0x14, 0x0a, 0x05, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x18, 0x1f, 0x20, 0x01, 0x28, 0x02,
	0x52, 0x05, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x12, 0x1e, 0x0a, 0x0a, 0x70, 0x65, 0x72, 0x63, 0x65,
	0x6e, 0x74, 0x61, 0x67, 0x65, 0x18, 0x20, 0x20, 0x01, 0x28, 0x02, 0x52, 0x0a, 0x70, 0x65, 0x72,
	0x63, 0x65, 0x6e, 0x74, 0x61, 0x67, 0x65, 0x12, 0x26, 0x0a, 0x0f, 0x77, 0x61, 0x6c, 0x6c, 0x5f,
	...
	0x06, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x73, 0x1a, 0x8e, 0x04, 0x0a, 0x03, 0x52, 0x75, 0x6e, 0x12,
	...
	0x6d, 0x65, 0x55, 0x73, 0x61, 0x67, 0x65, 0x12, 0x24, 0x0a, 0x0e, 0x63, 0x70, 0x75, 0x5f, 0x74,
	0x69, 0x6d, 0x65, 0x5f, 0x75, 0x73, 0x61, 0x67, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52,
	0x0c, 0x63, 0x70, 0x75, 0x54, 0x69, 0x6d, 0x65, 0x55, 0x73, 0x61, 0x67, 0x65, 0x12, 0x21, 0x0a,
	...
	0x67, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x02, 0x52, 0x0d, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72,
	0x63, 0x65, 0x55, 0x73, 0x61, 0x67, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x69, 0x6e, 0x64, 0x65, 0x78,
	...
	0x0d, 0x0a, 0x09, 0x45, 0x58, 0x45, 0x43, 0x55, 0x54, 0x49, 0x4e, 0x47, 0x10, 0x02, 0x12, 0x0b,
	...
	0x4c, 0x4f, 0x43, 0x4b, 0x45, 0x44, 0x10, 0x0b, 0x1a, 0xdc, 0x06, 0x0a, 0x05, 0x47, 0x72, 0x6f,
	0x75, 0x70, 0x12, 0x14, 0x0a, 0x05, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x0d, 0x52, 0x05, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x12, 0x1d, 0x0a, 0x0a, 0x74, 0x65, 0x73, 0x74,
	0x73, 0x65, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x74, 0x65,
	0x73, 0x74, 0x73, 0x65, 0x74, 0x49, 0x64, 0x12, 0x3d, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75,
	0x73, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x25, 0x2e, 0x65, 0x6f, 0x6c, 0x79, 0x6d, 0x70,
	...
	,
	...
	0x04, 0x72, 0x75, 0x6e, 0x73, 0x22, 0xc9, 0x01, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73,
	...
	0x0b, 0x22, 0x2a, 0x0a, 0x0b, 0x53, 0x63, 0x6f, 0x72, 0x69, 0x6e, 0x67, 0x4d, 0x6f, 0x64, 0x65,
	0x12, 0x08, 0x0a, 0x04, 0x4e, 0x4f, 0x4e, 0x45, 0x10, 0x00, 0x12, 0x08, 0x0a, 0x04, 0x45, 0x41,
	0x43, 0x48, 0x10, 0x01, 0x12, 0x07, 0x0a, 0x03, 0x41, 0x4c, 0x4c, 0x10, 0x02, 0x22, 0x28, 0x0a,
	0x0e, 0x46, 0x65, 0x65, 0x64, 0x62, 0x61, 0x63, 0x6b, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x12,
	0x0c, 0x0a, 0x08, 0x43, 0x4f, 0x4d, 0x50, 0x4c, 0x45, 0x54, 0x45, 0x10, 0x00, 0x12, 0x08, 0x0a,
	0x04, 0x49, 0x43, 0x50, 0x43, 0x10, 0x01, 0x22, 0x5f, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75,
	...
	0x41, 0x49, 0x4c, 0x55, 0x52, 0x45, 0x10, 0x06, 0x42, 0x33, 0x5a, 0x31, 0x67, 0x69, 0x74, 0x68,
...
var file_eolymp_atlas_submission_proto_goTypes = []interface{}{
	...
	(Submission_Group_ScoringMode)(0),    // 3: eolymp.atlas.Submission.Group.ScoringMode
	(Submission_Group_FeedbackPolicy)(0), // 4: eolymp.atlas.Submission.Group.FeedbackPolicy
...
var file_eolymp_atlas_submission_proto_depIdxs = []int32{
	...
	2, // 4: eolymp.atlas.Submission.Group.status:type_name -> eolymp.atlas.Submission.Group.Status
	3, // 5: eolymp.atlas.Submission.Group.scoring_mode:type_name -> eolymp.atlas.Submission.Group.ScoringMode
	4, // 6: eolymp.atlas.Submission.Group.feedback_policy:type_name -> eolymp.atlas.Submission.Group.FeedbackPolicy
	6, // 7: eolymp.atlas.Submission.Group.runs:type_name -> eolymp.atlas.Submission.Run
