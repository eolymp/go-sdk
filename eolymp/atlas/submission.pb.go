...
func (Submission_Group_Status) EnumDescriptor() ([]byte, []int) {
	return file_eolymp_atlas_submission_proto_rawDescGZIP(), []int{0, 1, 0}
}
...
type Submission_Run struct {
	...
	VerifierExecutionData   *Submission_Run_VerifierExecutionData   `protobuf:"bytes,30,opt,name=verifier_execution_data,json=verifierExecutionData,proto3" json:"verifier_execution_data,omitempty"`
	InteractorExecutionData *Submission_Run_InteractorExecutionData `protobuf:"bytes,40,opt,name=interactor_execution_data,json=interactorExecutionData,proto3" json:"interactor_execution_data,omitempty"`
}
...
func (x *Submission_Run) GetVerifierExecutionData() *Submission_Run_VerifierExecutionData {
	if x != nil {
...
func (x *Submission_Run) GetInteractorExecutionData() *Submission_Run_InteractorExecutionData {
	if x != nil {
...
type Submission_Run_VerifierExecutionData struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	LogUrl        string `protobuf:"bytes,1,opt,name=log_url,json=logUrl,proto3" json:"log_url,omitempty"`                         // URL for verifier's full log
	WallTimeUsage uint32 `protobuf:"varint,2,opt,name=wall_time_usage,json=wallTimeUsage,proto3" json:"wall_time_usage,omitempty"` // verifier's wall time usage in milliseconds
	MemoryUsage   uint32 `protobuf:"varint,3,opt,name=memory_usage,json=memoryUsage,proto3" json:"memory_usage,omitempty"`         // verifier's wall time usage in bytes
	ExitCode      uint32 `protobuf:"varint,4,opt,name=exit_code,json=exitCode,proto3" json:"exit_code,omitempty"`                  // verifier's exit code
}

func (x *Submission_Run_VerifierExecutionData) Reset() {
	*x = Submission_Run_VerifierExecutionData{}
	if protoimpl.UnsafeEnabled {
...
func (x *Submission_Run_VerifierExecutionData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Submission_Run_VerifierExecutionData) ProtoMessage() {}

func (x *Submission_Run_VerifierExecutionData) ProtoReflect() protoreflect.Message {
	mi := &file_eolymp_atlas_submission_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Submission_Run_VerifierExecutionData.ProtoReflect.Descriptor instead.
func (*Submission_Run_VerifierExecutionData) Descriptor() ([]byte, []int) {
	return file_eolymp_atlas_submission_proto_rawDescGZIP(), []int{0, 0, 0}
}

func (x *Submission_Run_VerifierExecutionData) GetLogUrl() string {
	if x != nil {
		return x.LogUrl
	}
	return ""
...
func (x *Submission_Run_VerifierExecutionData) GetWallTimeUsage() uint32 {
	if x != nil {
		return x.WallTimeUsage
	}
	return 0
...
func (x *Submission_Run_VerifierExecutionData) GetMemoryUsage() uint32 {
	if x != nil {
		return x.MemoryUsage
	}
	return 0
...
func (x *Submission_Run_VerifierExecutionData) GetExitCode() uint32 {
	if x != nil {
		return x.ExitCode
	}
	return 0
...
type Submission_Run_InteractorExecutionData struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	MemoryUsage   uint32 `protobuf:"varint,3,opt,name=memory_usage,json=memoryUsage,proto3" json:"memory_usage,omitempty"`         // interactor's wall time usage in bytes
...
func (x *Submission_Run_InteractorExecutionData) Reset() {
	*x = Submission_Run_InteractorExecutionData{}
	if protoimpl.UnsafeEnabled {
...
func (x *Submission_Run_InteractorExecutionData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Submission_Run_InteractorExecutionData) ProtoMessage() {}

func (x *Submission_Run_InteractorExecutionData) ProtoReflect() protoreflect.Message {
	mi := &file_eolymp_atlas_submission_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Submission_Run_InteractorExecutionData.ProtoReflect.Descriptor instead.
func (*Submission_Run_InteractorExecutionData) Descriptor() ([]byte, []int) {
	return file_eolymp_atlas_submission_proto_rawDescGZIP(), []int{0, 0, 1}
}

func (x *Submission_Run_InteractorExecutionData) GetLogUrl() string {
	if x != nil {
		return x.LogUrl
	}
	return ""
...
func (x *Submission_Run_InteractorExecutionData) GetWallTimeUsage() uint32 {
	if x != nil {
		return x.WallTimeUsage
	}
	return 0
...
func (x *Submission_Run_InteractorExecutionData) GetMemoryUsage() uint32 {
	if x != nil {
		return x.MemoryUsage
	}
	return 0
...
func (x *Submission_Run_InteractorExecutionData) GetExitCode() uint32 {
	if x != nil {
		return x.ExitCode
	}
	return 0
...
var file_eolymp_atlas_submission_proto_rawDesc = []byte{
	...
	0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x80, 0x14, 0x0a, 0x0a, 0x53, 0x75, 0x62, 0x6d,
	...
	0x72, 0x6f, 0x72, 0x12, 0x12, 0x0a, 0x04, 0x63, 0x6f, 0x73, 0x74, 0x18, 0x1e, 0x20, 0x01, 0x28,
	0x02, 0x52, 0x04, 0x63, 0x6f, 0x73, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x73, 0x63, 0x6f, 0x72, 0x65,
	0x18, 0x1f, 0x20, 0x01, 0x28, 0x02, 0x52, 0x05, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x12, 0x1e, 0x0a,
	0x0a, 0x70, 0x65, 0x72, 0x63, 0x65, 0x6e, 0x74, 0x61, 0x67, 0x65, 0x18, 0x20, 0x20, 0x01, 0x28,
	0x02, 0x52, 0x0a, 0x70, 0x65, 0x72, 0x63, 0x65, 0x6e, 0x74, 0x61, 0x67, 0x65, 0x12, 0x26, 0x0a,
	...
	0x55, 0x73, 0x61, 0x67, 0x65, 0x12, 0x36, 0x0a, 0x06, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x73, 0x18,
	0x32, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x65, 0x6f, 0x6c, 0x79, 0x6d, 0x70, 0x2e, 0x61,
	0x74, 0x6c, 0x61, 0x73, 0x2e, 0x53, 0x75, 0x62, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x2e,
	0x47, 0x72, 0x6f, 0x75, 0x70, 0x52, 0x06, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x73, 0x1a, 0xbb, 0x08,
	0x0a, 0x03, 0x52, 0x75, 0x6e, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x26, 0x0a, 0x0f, 0x77, 0x61, 0x6c, 0x6c, 0x5f, 0x74, 0x69,
	0x6d, 0x65, 0x5f, 0x75, 0x73, 0x61, 0x67, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0d,
	...
	0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0c, 0x63, 0x70, 0x75, 0x54, 0x69, 0x6d, 0x65, 0x55, 0x73,
	0x61, 0x67, 0x65, 0x12, 0x21, 0x0a, 0x0c, 0x6d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x5f, 0x75, 0x73,
	0x61, 0x67, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0b, 0x6d, 0x65, 0x6d, 0x6f, 0x72,
	0x79, 0x55, 0x73, 0x61, 0x67, 0x65, 0x12, 0x25, 0x0a, 0x0e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72,
	0x63, 0x65, 0x5f, 0x75, 0x73, 0x61, 0x67, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x02, 0x52, 0x0d,
	...
	0x64, 0x65, 0x78, 0x12, 0x17, 0x0a, 0x07, 0x74, 0x65, 0x73, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x0b,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x74, 0x65, 0x73, 0x74, 0x49, 0x64, 0x12, 0x12, 0x0a, 0x04,
	0x63, 0x6f, 0x73, 0x74, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x02, 0x52, 0x04, 0x63, 0x6f, 0x73, 0x74,
	0x12, 0x14, 0x0a, 0x05, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x02, 0x52,
	0x05, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x12, 0x3b, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73,
	0x18, 0x14, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x23, 0x2e, 0x65, 0x6f, 0x6c, 0x79, 0x6d, 0x70, 0x2e,
	...
	,
	...
	0x6f, 0x72, 0x79, 0x5f, 0x75, 0x73, 0x61, 0x67, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52,
	...
	0x08, 0x65, 0x78, 0x69, 0x74, 0x43, 0x6f, 0x64, 0x65, 0x22, 0xdf, 0x01, 0x0a, 0x06, 0x53, 0x74,
	0x61, 0x74, 0x75, 0x73, 0x12, 0x08, 0x0a, 0x04, 0x4e, 0x4f, 0x4e, 0x45, 0x10, 0x00, 0x12, 0x0b,
	0x0a, 0x07, 0x43, 0x52, 0x45, 0x41, 0x54, 0x45, 0x44, 0x10, 0x01, 0x12, 0x0d, 0x0a, 0x09, 0x45,
	0x58, 0x45, 0x43, 0x55, 0x54, 0x49, 0x4e, 0x47, 0x10, 0x02, 0x12, 0x0b, 0x0a, 0x07, 0x54, 0x49,
	0x4d, 0x45, 0x4f, 0x55, 0x54, 0x10, 0x03, 0x12, 0x11, 0x0a, 0x0d, 0x43, 0x50, 0x55, 0x5f, 0x45,
	...
	,
	...
	0x73, 0x69, 0x6f, 0x6e, 0x2e, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x75,
	...
	0x07, 0x46, 0x41, 0x49, 0x4c, 0x55, 0x52, 0x45, 0x10, 0x06, 0x42, 0x2d, 0x5a, 0x2b, 0x67, 0x69,
...
var file_eolymp_atlas_submission_proto_goTypes = []interface{}{
	...
	(Submission_Run_Status)(0),                     // 1: eolymp.atlas.Submission.Run.Status
	(Submission_Group_Status)(0),                   // 2: eolymp.atlas.Submission.Group.Status
	...
	(*Submission_Run_VerifierExecutionData)(nil),   // 6: eolymp.atlas.Submission.Run.VerifierExecutionData
	(*Submission_Run_InteractorExecutionData)(nil), // 7: eolymp.atlas.Submission.Run.InteractorExecutionData
	(*timestamppb.Timestamp)(nil),                  // 8: google.protobuf.Timestamp
	(ScoringMode)(0),                               // 9: eolymp.atlas.ScoringMode
	(FeedbackPolicy)(0),                            // 10: eolymp.atlas.FeedbackPolicy
}
var file_eolymp_atlas_submission_proto_depIdxs = []int32{
	8,  // 0: eolymp.atlas.Submission.submitted_at:type_name -> google.protobuf.Timestamp
	0,  // 1: eolymp.atlas.Submission.status:type_name -> eolymp.atlas.Submission.Status
	5,  // 2: eolymp.atlas.Submission.groups:type_name -> eolymp.atlas.Submission.Group
	1,  // 3: eolymp.atlas.Submission.Run.status:type_name -> eolymp.atlas.Submission.Run.Status
	6,  // 4: eolymp.atlas.Submission.Run.verifier_execution_data:type_name -> eolymp.atlas.Submission.Run.VerifierExecutionData
	7,  // 5: eolymp.atlas.Submission.Run.interactor_execution_data:type_name -> eolymp.atlas.Submission.Run.InteractorExecutionData
	2,  // 6: eolymp.atlas.Submission.Group.status:type_name -> eolymp.atlas.Submission.Group.Status
	9,  // 7: eolymp.atlas.Submission.Group.scoring_mode:type_name -> eolymp.atlas.ScoringMode
	10, // 8: eolymp.atlas.Submission.Group.feedback_policy:type_name -> eolymp.atlas.FeedbackPolicy
	4,  // 9: eolymp.atlas.Submission.Group.runs:type_name -> eolymp.atlas.Submission.Run
...
func file_eolymp_atlas_submission_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_eolymp_atlas_submission_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Submission_Run_VerifierExecutionData); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_eolymp_atlas_submission_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Submission_Run_InteractorExecutionData); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
