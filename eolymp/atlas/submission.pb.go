...
func (Submission_Group_Status) Descriptor() protoreflect.EnumDescriptor {
	return file_eolymp_atlas_submission_proto_enumTypes[4].Descriptor()
}

func (Submission_Group_Status) Type() protoreflect.EnumType {
	return &file_eolymp_atlas_submission_proto_enumTypes[4]
}
...
var file_eolymp_atlas_submission_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xe0, 0x19, 0x0a, 0x0a, 0x53, 0x75, 0x62, 0x6d, 0x69, 0x73, 0x73,
	...
	0x4e, 0x5f, 0x45, 0x52, 0x52, 0x4f, 0x52, 0x10, 0x0c, 0x22, 0x2b, 0x0a, 0x05, 0x45, 0x78, 0x74,
	0x72, 0x61, 0x12, 0x0c, 0x0a, 0x08, 0x4e, 0x4f, 0x5f, 0x45, 0x58, 0x54, 0x52, 0x41, 0x10, 0x00,
	0x12, 0x0a, 0x0a, 0x06, 0x47, 0x52, 0x4f, 0x55, 0x50, 0x53, 0x10, 0x03, 0x12, 0x08, 0x0a, 0x04,
	0x52, 0x55, 0x4e, 0x53, 0x10, 0x04, 0x22, 0x5f, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73,
...
var file_eolymp_atlas_submission_proto_enumTypes = make([]protoimpl.EnumInfo, 5)
...
var file_eolymp_atlas_submission_proto_goTypes = []any{
	...
	(Submission_Run_Status)(0),                 // 3: eolymp.atlas.Submission.Run.Status
	(Submission_Group_Status)(0),               // 4: eolymp.atlas.Submission.Group.Status
	(*Submission)(nil),                         // 5: eolymp.atlas.Submission
	(*Submission_CheckerExecutionData)(nil),    // 6: eolymp.atlas.Submission.CheckerExecutionData
	(*Submission_InteractorExecutionData)(nil), // 7: eolymp.atlas.Submission.InteractorExecutionData
	(*Submission_Run)(nil),                     // 8: eolymp.atlas.Submission.Run
	(*Submission_Group)(nil),                   // 9: eolymp.atlas.Submission.Group
	(*timestamppb.Timestamp)(nil),              // 10: google.protobuf.Timestamp
	(*executor.Stats)(nil),                     // 11: eolymp.executor.Stats
	(ScoringMode)(0),                           // 12: eolymp.atlas.ScoringMode
	(FeedbackPolicy)(0),                        // 13: eolymp.atlas.FeedbackPolicy
}
var file_eolymp_atlas_submission_proto_depIdxs = []int32{
	...
	1,  // 1: eolymp.atlas.Submission.status:type_name -> eolymp.atlas.Submission.Status
	2,  // 2: eolymp.atlas.Submission.verdict:type_name -> eolymp.atlas.Submission.Verdict
	9,  // 3: eolymp.atlas.Submission.groups:type_name -> eolymp.atlas.Submission.Group
	3,  // 4: eolymp.atlas.Submission.Run.status:type_name -> eolymp.atlas.Submission.Run.Status
	2,  // 5: eolymp.atlas.Submission.Run.verdict:type_name -> eolymp.atlas.Submission.Verdict
	11, // 6: eolymp.atlas.Submission.Run.debug_stats:type_name -> eolymp.executor.Stats
	6,  // 7: eolymp.atlas.Submission.Run.checker_execution_data:type_name -> eolymp.atlas.Submission.CheckerExecutionData
	11, // 8: eolymp.atlas.Submission.Run.checker_stats:type_name -> eolymp.executor.Stats
	7,  // 9: eolymp.atlas.Submission.Run.interactor_execution_data:type_name -> eolymp.atlas.Submission.InteractorExecutionData
	11, // 10: eolymp.atlas.Submission.Run.interactor_stats:type_name -> eolymp.executor.Stats
	4,  // 11: eolymp.atlas.Submission.Group.status:type_name -> eolymp.atlas.Submission.Group.Status
	2,  // 12: eolymp.atlas.Submission.Group.verdict:type_name -> eolymp.atlas.Submission.Verdict
	12, // 13: eolymp.atlas.Submission.Group.scoring_mode:type_name -> eolymp.atlas.ScoringMode
	13, // 14: eolymp.atlas.Submission.Group.feedback_policy:type_name -> eolymp.atlas.FeedbackPolicy
	8,  // 15: eolymp.atlas.Submission.Group.runs:type_name -> eolymp.atlas.Submission.Run
