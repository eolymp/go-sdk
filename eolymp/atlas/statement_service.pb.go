...
func (x *ListStatementVersionsInput) Reset() {
	*x = ListStatementVersionsInput{}
	mi := &file_eolymp_atlas_statement_service_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListStatementVersionsInput) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListStatementVersionsInput) ProtoMessage() {}

func (x *ListStatementVersionsInput) ProtoReflect() protoreflect.Message {
	mi := &file_eolymp_atlas_statement_service_proto_msgTypes[19]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (x *ListStatementVersionsInput) GetOffset() int32 {
	if x != nil {
		return x.Offset
	}
	return 0
...
func (x *ListStatementVersionsInput) GetSize() int32 {
	if x != nil {
		return x.Size
	}
	return 0
...
func (x *ListStatementVersionsInput) GetExtra() []Statement_Extra_Field {
	if x != nil {
		return x.Extra
	}
	return nil
...
type ListStatementVersionsOutput struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Total         int32                  `protobuf:"varint,1,opt,name=total,proto3" json:"total,omitempty"`
	Items         []*Statement           `protobuf:"bytes,2,rep,name=items,proto3" json:"items,omitempty"`
	unknownFields protoimpl.UnknownFields
...
func (x *ListStatementVersionsOutput) Reset() {
	*x = ListStatementVersionsOutput{}
	mi := &file_eolymp_atlas_statement_service_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListStatementVersionsOutput) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListStatementVersionsOutput) ProtoMessage() {}

func (x *ListStatementVersionsOutput) ProtoReflect() protoreflect.Message {
	mi := &file_eolymp_atlas_statement_service_proto_msgTypes[20]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListStatementVersionsOutput.ProtoReflect.Descriptor instead.
func (*ListStatementVersionsOutput) Descriptor() ([]byte, []int) {
	return file_eolymp_atlas_statement_service_proto_rawDescGZIP(), []int{20}
}

func (x *ListStatementVersionsOutput) GetTotal() int32 {
	if x != nil {
		return x.Total
	}
	return 0
...
func (x *ListStatementVersionsOutput) GetItems() []*Statement {
	if x != nil {
		return x.Items
	}
	return nil
...
const file_eolymp_atlas_statement_service_proto_rawDesc = "" +
	"\n" +
	"$eolymp/atlas/statement_service.proto\x12\feolymp.atlas\x1a\x1eeolymp/annotations/audit.proto\x1a\x1deolymp/annotations/http.proto\x1a\"eolymp/annotations/namespace.proto\x1a\"eolymp/annotations/ratelimit.proto\x1a\x1eeolymp/annotations/scope.proto\x1a\x1ceolymp/atlas/statement.proto\"\x96\x01\n" +
	...
	"\x05total\x18\x01 \x01(\x05R\x05total\x12-\n" +
	"\x05items\x18\x02 \x03(\v2\x17.eolymp.atlas.StatementR\x05items2\xf3\x0f\n" +
	...
	"\x13atlas:problem:write\xa2\xe3\n" +
	"\x04\xa8\xe3\n" +
	"\x02\x82\xd3\xe4\x93\x022\x1a0/problems/{problem_id}/statements/{statement_id}\x12\xc6\x01\n" +
	"\x0fDeleteStatement\x12\".eolymp.atlas.DeleteStatementInput\x1a#.eolymp.atlas.DeleteStatementOutput\"j\xea\xe2\n" +
	"\v\xf5\xe2\n" +
	"\x00\x00\x80?\xf8\xe2\n" +
	"\x05\x82\xe3\n" +
	"\x17\x8a\xe3\n" +
	"\x13atlas:problem:write\xa2\xe3\n" +
	"\x04\xa8\xe3\n" +
	"\x03\x82\xd3\xe4\x93\x022*0/problems/{problem_id}/statements/{statement_id}\x12\xcb\x01\n" +
	"\x11DescribeStatement\x12$.eolymp.atlas.DescribeStatementInput\x1a%.eolymp.atlas.DescribeStatementOutput\"i\xea\xe2\n" +
	"\v\xf5\xe2\n" +
	...
	"\x04\xa8\xe3\n" +
	"\x01\x82\xd3\xe4\x93\x022\x120/problems/{problem_id}/statements/{statement_id}\x12\xb6\x01\n" +
	...
	"\x0fExportStatement\x12\".eolymp.atlas.ExportStatementInput\x1a#.eolymp.atlas.ExportStatementOutput\"p\xea\xe2\n" +
	"\v\xf5\xe2\n" +
	"\x00\x00\xa0A\xf8\xe2\n" +
	"d\x82\xe3\n" +
	"\x16\x8a\xe3\n" +
	"\x12atlas:problem:read\xa2\xe3\n" +
	"\x04\xa8\xe3\n" +
	"\x01\x82\xd3\xe4\x93\x029\"7/problems/{problem_id}/statements/{statement_id}/export\x12\xe0\x01\n" +
	...
	"\x12atlas:problem:read\xa2\xe3\n" +
	"\x04\xa8\xe3\n" +
	"\x01\x82\xd3\xe4\x93\x02;\x129/problems/{problem_id}/statements/{statement_id}/versions\x1a\x1b\x82\xf0\xf0\xe4\x01\x15eolymp.universe.SpaceB-Z+github.com/eolymp/go-sdk/eolymp/atlas;atlasb\x06proto3"
...
var file_eolymp_atlas_statement_service_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
var file_eolymp_atlas_statement_service_proto_goTypes = []any{
	...
	(*ListStatementVersionsInput)(nil),  // 19: eolymp.atlas.ListStatementVersionsInput
...
var file_eolymp_atlas_statement_service_proto_depIdxs = []int32{
	...
	21, // 1: eolymp.atlas.StatementChangedEvent.after:type_name -> eolymp.atlas.Statement
	22, // 2: eolymp.atlas.ListStatementsInput.extra:type_name -> eolymp.atlas.Statement.Extra.Field
	21, // 3: eolymp.atlas.ListStatementsOutput.items:type_name -> eolymp.atlas.Statement
	22, // 4: eolymp.atlas.DescribeStatementInput.extra:type_name -> eolymp.atlas.Statement.Extra.Field
	21, // 5: eolymp.atlas.DescribeStatementOutput.statement:type_name -> eolymp.atlas.Statement
	22, // 6: eolymp.atlas.LookupStatementInput.extra:type_name -> eolymp.atlas.Statement.Extra.Field
	21, // 7: eolymp.atlas.LookupStatementOutput.statement:type_name -> eolymp.atlas.Statement
