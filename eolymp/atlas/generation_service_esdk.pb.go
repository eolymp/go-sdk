...
type _GenerationServiceHttpClient interface {
	Do(*http.Request) (*http.Response, error)
}

type GenerationServiceService struct {
	base string
	cli  _GenerationServiceHttpClient
}

// NewGenerationServiceHttpClient constructs client for GenerationService
func NewGenerationServiceHttpClient(url string, cli _GenerationServiceHttpClient) *GenerationServiceService {
	if url == "" {
	...
	return &GenerationServiceService{base: url, cli: cli}
}

func (s *GenerationServiceService) do(ctx context.Context, verb, path string, in, out proto.Message) (err error) {
	var body io.Reader
