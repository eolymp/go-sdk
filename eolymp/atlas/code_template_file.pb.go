...
var file_eolymp_atlas_code_template_file_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x6c, 0x61, 0x73, 0x22, 0x39, 0x0a, 0x04, 0x46, 0x69, 0x6c, 0x65, 0x12, 0x12, 0x0a,
...
var file_eolymp_atlas_code_template_file_proto_goTypes = []interface{}{
...
func file_eolymp_atlas_code_template_file_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_eolymp_atlas_code_template_file_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*File); i {
			case 0:
				return &v.state
			case 1:
