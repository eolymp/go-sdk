...
type Script struct {
	...
	Files []*Script_File `protobuf:"bytes,20,rep,name=files,proto3" json:"files,omitempty"`
}
...
var file_eolymp_atlas_script_proto_rawDesc = []byte{
	...
	0x79, 0x6d, 0x70, 0x2e, 0x61, 0x74, 0x6c, 0x61, 0x73, 0x22, 0xe9, 0x01, 0x0a, 0x06, 0x53, 0x63,
	...
	0x75, 0x72, 0x63, 0x65, 0x5f, 0x75, 0x72, 0x6c, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09,
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x55, 0x72, 0x6c, 0x12, 0x2f, 0x0a, 0x05, 0x66, 0x69, 0x6c,
	0x65, 0x73, 0x18, 0x14, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x65, 0x6f, 0x6c, 0x79, 0x6d,
	0x70, 0x2e, 0x61, 0x74, 0x6c, 0x61, 0x73, 0x2e, 0x53, 0x63, 0x72, 0x69, 0x70, 0x74, 0x2e, 0x46,
	0x69, 0x6c, 0x65, 0x52, 0x05, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x1a, 0x39, 0x0a, 0x04, 0x46, 0x69,
	...
	0x63, 0x65, 0x55, 0x72, 0x6c, 0x42, 0x2d, 0x5a, 0x2b, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
...
var file_eolymp_atlas_script_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_eolymp_atlas_script_proto_goTypes = []any{
	(*Script)(nil),      // 0: eolymp.atlas.Script
	(*Script_File)(nil), // 1: eolymp.atlas.Script.File
}
var file_eolymp_atlas_script_proto_depIdxs = []int32{
	1, // 0: eolymp.atlas.Script.files:type_name -> eolymp.atlas.Script.File
...
func file_eolymp_atlas_script_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_eolymp_atlas_script_proto_msgTypes[1].Exporter = func(v any, i int) any {
