...
type _CodeTemplateServiceHttpClient interface {
	Do(*http.Request) (*http.Response, error)
}

type CodeTemplateServiceService struct {
	base string
	cli  _CodeTemplateServiceHttpClient
}
...
func NewCodeTemplateServiceHttpClient(url string, cli _CodeTemplateServiceHttpClient) *CodeTemplateServiceService {
	...
	return &CodeTemplateServiceService{base: url, cli: cli}
}

func (s *CodeTemplateServiceService) do(ctx context.Context, verb, path string, in, out proto.Message) (err error) {
	var body io.Reader
