...
type _LibraryServiceHttpClient interface {
	Do(*http.Request) (*http.Response, error)
}

type LibraryServiceService struct {
	base string
	cli  _LibraryServiceHttpClient
}
...
func NewLibraryServiceHttpClient(url string, cli _LibraryServiceHttpClient) *LibraryServiceService {
	...
	return &LibraryServiceService{base: url, cli: cli}
}

func (s *LibraryServiceService) do(ctx context.Context, verb, path string, in, out proto.Message) (err error) {
	var body io.Reader
...
func (s *LibraryServiceService) CreateProblem(ctx context.Context, in *CreateProblemInput) (*CreateProblemOutput, error) {
...
func (s *LibraryServiceService) DeleteProblem(ctx context.Context, in *DeleteProblemInput) (*DeleteProblemOutput, error) {
...
func (s *LibraryServiceService) DescribeProblem(ctx context.Context, in *DescribeProblemInput) (*DescribeProblemOutput, error) {
...
func (s *LibraryServiceService) ListProblems(ctx context.Context, in *ListProblemsInput) (*ListProblemsOutput, error) {
