...
func RegisterConfigurationServiceHttpHandlers(router *mux.Router, prefix string, cli ConfigurationServiceClient) {
	router.Handle(prefix+"/configs/atlas", _ConfigurationService_DescribeConfig_Rule0(cli)).
		Methods("GET").
		Name("eolymp.atlas.ConfigurationService.DescribeConfig")
	router.Handle(prefix+"/configs/atlas", _ConfigurationService_UpdateConfig_Rule0(cli)).
		Methods("PUT").
		Name("eolymp.atlas.ConfigurationService.UpdateConfig")
}
...
func _ConfigurationService_DescribeConfig_Rule0(cli ConfigurationServiceClient) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		in := &DescribeConfigInput{}
		...
		out, err := cli.DescribeConfig(r.Context(), in, grpc.Header(&header), grpc.Trailer(&trailer))
		if err != nil {
			_ConfigurationService_HTTPWriteErrorResponse(w, err)
			return
		}
...
func _ConfigurationService_UpdateConfig_Rule0(cli ConfigurationServiceClient) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		out, err := cli.UpdateConfig(r.Context(), in, grpc.Header(&header), grpc.Trailer(&trailer))
		if err != nil {
			_ConfigurationService_HTTPWriteErrorResponse(w, err)
			return
		}
