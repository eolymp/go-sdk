...
type Template struct {
	...
	SourceErn string  `protobuf:"bytes,20,opt,name=source_ern,json=sourceErn,proto3" json:"source_ern,omitempty"` // deprecated
	HeaderErn string  `protobuf:"bytes,21,opt,name=header_ern,json=headerErn,proto3" json:"header_ern,omitempty"` // deprecated
	FooterErn string  `protobuf:"bytes,22,opt,name=footer_ern,json=footerErn,proto3" json:"footer_ern,omitempty"` // deprecated
...
var file_eolymp_atlas_code_template_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa2, 0x02, 0x0a, 0x08, 0x54, 0x65, 0x6d, 0x70,
