...
type _EditorialServiceHttpClient interface {
	Do(*http.Request) (*http.Response, error)
}

type EditorialServiceService struct {
	base string
	cli  _EditorialServiceHttpClient
}
...
func NewEditorialServiceHttpClient(url string, cli _EditorialServiceHttpClient) *EditorialServiceService {
	...
	return &EditorialServiceService{base: url, cli: cli}
}

func (s *EditorialServiceService) do(ctx context.Context, verb, path string, in, out proto.Message) (err error) {
	var body io.Reader
