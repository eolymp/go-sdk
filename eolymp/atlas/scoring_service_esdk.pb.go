...
type _ScoringServiceHttpClient interface {
	Do(*http.Request) (*http.Response, error)
}

type ScoringServiceService struct {
	base string
	cli  _ScoringServiceHttpClient
}
...
func NewScoringServiceHttpClient(url string, cli _ScoringServiceHttpClient) *ScoringServiceService {
	...
	return &ScoringServiceService{base: url, cli: cli}
}

func (s *ScoringServiceService) do(ctx context.Context, verb, path string, in, out proto.Message) (err error) {
	var body io.Reader
...
func (s *ScoringServiceService) DescribeScore(ctx context.Context, in *DescribeScoreInput) (*DescribeScoreOutput, error) {
	...
	path := "/scores/" + url.PathEscape(in.GetUserId())
