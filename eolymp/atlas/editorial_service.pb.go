...
const file_eolymp_atlas_editorial_service_proto_rawDesc = "" +
	"\n" +
	"$eolymp/atlas/editorial_service.proto\x12\feolymp.atlas\x1a\x1eeolymp/annotations/audit.proto\x1a\x1deolymp/annotations/http.proto\x1a\"eolymp/annotations/namespace.proto\x1a\"eolymp/annotations/ratelimit.proto\x1a\x1eeolymp/annotations/scope.proto\x1a\x1ceolymp/atlas/editorial.proto\"\xb6\x01\n" +
	...
	"\x06job_id\x18\x01 \x01(\tR\x05jobId2\xca\f\n" +
	"\x10EditorialService\x12\xb7\x01\n" +
	...
	"\x13atlas:problem:write\xa2\xe3\n" +
	"\x04\xa8\xe3\n" +
	"\x02\x82\xd3\xe4\x93\x022\x1a0/problems/{problem_id}/editorials/{editorial_id}\x12\xc6\x01\n" +
	"\x0fDeleteEditorial\x12\".eolymp.atlas.DeleteEditorialInput\x1a#.eolymp.atlas.DeleteEditorialOutput\"j\xea\xe2\n" +
	"\v\xf5\xe2\n" +
	"\x00\x00\x80?\xf8\xe2\n" +
	"\x05\x82\xe3\n" +
	"\x17\x8a\xe3\n" +
	"\x13atlas:problem:write\xa2\xe3\n" +
	"\x04\xa8\xe3\n" +
	"\x03\x82\xd3\xe4\x93\x022*0/problems/{problem_id}/editorials/{editorial_id}\x12\xcb\x01\n" +
	"\x11DescribeEditorial\x12$.eolymp.atlas.DescribeEditorialInput\x1a%.eolymp.atlas.DescribeEditorialOutput\"i\xea\xe2\n" +
	"\v\xf5\xe2\n" +
	...
	"\x04\xa8\xe3\n" +
	"\x01\x82\xd3\xe4\x93\x022\x120/problems/{problem_id}/editorials/{editorial_id}\x12\xb5\x01\n" +
	...
	"\x13atlas:problem:write\xa2\xe3\n" +
	"\x04\xa8\xe3\n" +
	"\x02\x82\xd3\xe4\x93\x02-\"+/problems/{problem_id}/editorials:translate\x1a\x1b\x82\xf0\xf0\xe4\x01\x15eolymp.universe.SpaceB-Z+github.com/eolymp/go-sdk/eolymp/atlas;atlasb\x06proto3"
