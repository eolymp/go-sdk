...
var file_eolymp_atlas_testing_config_proto_goTypes = []interface{}{
...
func file_eolymp_atlas_testing_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_eolymp_atlas_testing_config_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
