...
type _ValidationServiceHttpClient interface {
	Do(*http.Request) (*http.Response, error)
}

type ValidationServiceService struct {
	base string
	cli  _ValidationServiceHttpClient
}

// NewValidationServiceHttpClient constructs client for ValidationService
func NewValidationServiceHttpClient(url string, cli _ValidationServiceHttpClient) *ValidationServiceService {
	if url == "" {
	...
	return &ValidationServiceService{base: url, cli: cli}
}

func (s *ValidationServiceService) do(ctx context.Context, verb, path string, in, out proto.Message) (err error) {
	var body io.Reader
