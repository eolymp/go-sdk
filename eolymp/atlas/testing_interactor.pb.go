...
var file_eolymp_atlas_testing_interactor_proto_rawDesc = []byte{
...
var (
	...
	file_eolymp_atlas_testing_interactor_proto_rawDescData = file_eolymp_atlas_testing_interactor_proto_rawDesc
)
...
func file_eolymp_atlas_testing_interactor_proto_rawDescGZIP() []byte {
	file_eolymp_atlas_testing_interactor_proto_rawDescOnce.Do(func() {
		file_eolymp_atlas_testing_interactor_proto_rawDescData = protoimpl.X.CompressGZIP(file_eolymp_atlas_testing_interactor_proto_rawDescData)
	})
...
func file_eolymp_atlas_testing_interactor_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_eolymp_atlas_testing_interactor_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_eolymp_atlas_testing_interactor_proto_rawDesc = nil
